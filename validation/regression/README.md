...
- Temporary compatibility mirrors should be declared only if regression-policy migration debt is reintroduced; there are no active regression mirror registries right now.
