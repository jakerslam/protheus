  ...
  writeJsonl(path.join(autotestRunsDir, `${dateStr}.jsonl`), [
    {
      ...
      results: [
        {
          id: 'tst_fail_1',
          command: 'node client/memory/tools/tests/autotest_doctor.test.js',
          guard_ok: true,
          ok: false,
          exit_code: 1,
  ...
  writeJsonl(path.join(autotestRunsDir, `${dateStr}.jsonl`), [
    {
      ...
      results: [
        {
          id: 'tst_fail_2',
          command: 'node client/memory/tools/tests/autotest_doctor.test.js; echo hacked',
          guard_ok: true,
          ok: false,
          exit_code: 1,
      ...
      results: [
        {
          ...
          command: 'node client/memory/tools/tests/__doctor_missing_fixture__.test.js',
          guard_ok: true,
          ok: false,
          exit_code: 1,
