...
function run() {
  ...
  const pointersPath = path.join(repoRoot, 'local', 'state', 'memory', 'adaptive_pointers.jsonl');
  const pointerIndexPath = path.join(repoRoot, 'local', 'state', 'memory', 'adaptive_pointer_index.json');
