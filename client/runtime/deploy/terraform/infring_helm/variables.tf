...
variable "namespace" {
  description = "Kubernetes namespace for Infring"
  type        = string
  default     = "infring"
}

variable "chart_path" {
  description = "Path to the Infring Helm chart"
  type        = string
  default     = "../../helm/infring"
}
...
variable "daemon_enabled" {
  description = "Enable always-on infringd deployment"
  type        = bool
  default     = true
}
