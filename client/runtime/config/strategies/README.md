...
Purpose: keep specialized objective/risk policy out of `client/runtime/systems/` code.
...
- Keep `client/runtime/systems/` broadly reusable and strategy-agnostic.
- Keep platform specifics in `client/cognition/skills/` and high-churn shortcuts in `client/cognition/habits/`.
