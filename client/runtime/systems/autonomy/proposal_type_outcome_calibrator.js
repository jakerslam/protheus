...
const LANE_ID = 'SYSTEMS-AUTONOMY-PROPOSAL-TYPE-OUTCOME-CALIBRATOR';
const bridge = createOpsLaneBridge(__dirname, 'proposal_type_outcome_calibrator', 'legacy-retired-lane');
