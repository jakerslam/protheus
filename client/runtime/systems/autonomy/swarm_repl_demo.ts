...
// Layer ownership: client/runtime/systems/autonomy (thin demo shell only).
// Purpose: optional REPL/demo ergonomics over the authoritative swarm bridge.
// SRS coverage: V6-WORKFLOW-007.6

const path = require('path');
const bridge = require('./swarm_sessions_bridge.ts');
...
function printUsage() {
  process.stdout.write(
    [
      ...
      '',
      'This shell is optional and non-authoritative. Every step delegates to swarm_sessions_bridge.ts.',
    ].join('\n') + '\n'
  );
}
