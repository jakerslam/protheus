...
const LANE_ID = 'SYSTEMS-AUTONOMY-CIVIC-DUTY-ALLOCATION-ENGINE';
const bridge = createOpsLaneBridge(__dirname, 'civic_duty_allocation_engine', 'legacy-retired-lane');
