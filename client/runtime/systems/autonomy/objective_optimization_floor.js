...
const LANE_ID = 'SYSTEMS-AUTONOMY-OBJECTIVE-OPTIMIZATION-FLOOR';
const bridge = createOpsLaneBridge(__dirname, 'objective_optimization_floor', 'legacy-retired-lane');
