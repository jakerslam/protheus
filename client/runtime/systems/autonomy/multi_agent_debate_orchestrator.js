...
const LANE_ID = 'SYSTEMS-AUTONOMY-MULTI-AGENT-DEBATE-ORCHESTRATOR';
const bridge = createOpsLaneBridge(__dirname, 'multi_agent_debate_orchestrator', 'legacy-retired-lane');
