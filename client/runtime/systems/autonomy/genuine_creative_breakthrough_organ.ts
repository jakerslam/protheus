...
const SYSTEM_ID = 'SYSTEMS-AUTONOMY-GENUINE_CREATIVE_BREAKTHROUGH_ORGAN';
const bridge = createOpsLaneBridge(__dirname, 'genuine_creative_breakthrough_organ', 'runtime-systems', {
  inheritStdio: true
});
