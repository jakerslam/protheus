...
const LANE_ID = 'SYSTEMS-AUTONOMY-BACKLOG-AUTOSCALE-RUST-BRIDGE';
const bridge = createOpsLaneBridge(__dirname, 'backlog_autoscale_rust_bridge', 'legacy-retired-lane');
