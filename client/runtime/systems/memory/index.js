...
function buildMemorySecurityRequest(command, args, opts = {}) {
  ...
  return {
    ...
    actor: cleanText(opts.actor || 'client/runtime/systems/memory/index.ts', 120),
...
function runMemoryCli(command, args = [], timeoutMs = 180000, opts = {}) {
  ...
  return {
    ok: false,
    engine: 'memory_ambient_conduit',
    error: 'memory_ambient_required_conduit_only',
    payload: null,
    status: 1,
    stdout: '',
    stderr: 'memory_ambient_required_conduit_only',
    security_gate: securityGate.gate || null,
