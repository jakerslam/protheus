/* generated: dashboard svelte island bundle (chat_input_footer_shell) */
(() => {
  ...
  // chat_input_footer_shell.svelte.js
  ...
  var Chat_input_footer_shell = class extends SvelteComponent {
    constructor(options) {
      super();
