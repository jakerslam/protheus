...
<script>
  ...
  const composerMenuAnchorId = 'composer-plus-menu-anchor-' + Math.random().toString(36).slice(2);
  let inputText = '';
  let focused = false;
  let fileInput;
  let textarea;
          ...
          <div class="composer-main-row">
            <div class="composer-display-pill" aria-label="Message input controls">
              ...
              <div class="composer-menu-pill composer-shared-input-pill">
                <div id={composerMenuAnchorId} data-popup-origin-anchor class="composer-plus-wrap composer-icon-left">
                  ...
                  <infring-taskbar-menu-shell class="composer-plus-menu dashboard-dropdown-surface" anchorid={composerMenuAnchorId} fallbackside="bottom" layoutkey="composer-plus-menu">
