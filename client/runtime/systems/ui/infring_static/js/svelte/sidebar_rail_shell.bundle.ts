/* generated: dashboard svelte island bundle (sidebar_rail_shell) */
(() => {
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    let { dragbarSurface = "chat-sidebar" } = $$props;
    let { wall = "" } = $$props;
  ...
  var Sidebar_rail_shell = class extends SvelteComponent {
    constructor(options) {
      super();
