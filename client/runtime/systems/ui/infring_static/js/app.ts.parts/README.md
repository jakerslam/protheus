...
Purpose:
- keep temporary shard boundaries visible while `app.ts` is still being collapsed into real modules
...
- `app.ts.parts/**` must not be counted as additive authored production source
