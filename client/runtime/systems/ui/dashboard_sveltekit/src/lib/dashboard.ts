...
export const dashboardPages: DashboardPage[] = [
  ...
  { key: 'agents', title: 'Agents', summary: 'Agent roster, creation, and lifecycle management.', mode: 'native', churn: 'high' },
  { key: 'sessions', title: 'Memory', summary: 'Session history, continuity, and recall surfaces.', mode: 'native', churn: 'medium' },
  { key: 'approvals', title: 'Approvals', summary: 'Queued approvals and gated operator actions.', mode: 'native', churn: 'medium' },
  { key: 'comms', title: 'Comms', summary: 'Connected channels and outbound message surfaces.', mode: 'native', churn: 'medium' },
  { key: 'workflows', title: 'Workflows', summary: 'Workflow definitions, orchestration, and runs.', mode: 'native', churn: 'high' },
  { key: 'scheduler', title: 'Scheduler', summary: 'Automations, cadence, and heartbeat timing.', mode: 'native', churn: 'medium' },
  { key: 'channels', title: 'Channels', summary: 'External messaging and inbound/outbound connectors.', mode: 'native', churn: 'medium' },
  { key: 'eyes', title: 'Eyes', summary: 'Visual sensing, receipts, and manual capture lanes.', mode: 'native', churn: 'medium' },
  { key: 'skills', title: 'Skills', summary: 'Installed skill inventory and capability browser.', mode: 'native', churn: 'medium' },
  { key: 'hands', title: 'Hands', summary: 'Manual actions, desktop control, and actuation status.', mode: 'native', churn: 'medium' },
  { key: 'analytics', title: 'Analytics', summary: 'Usage, spend, and per-model breakdowns.', mode: 'native', churn: 'medium' },
  { key: 'logs', title: 'Logs', summary: 'Recent audit activity and operator-facing receipts.', mode: 'native', churn: 'medium' },
  ...
  { key: 'wizard', title: 'Wizard', summary: 'Guided setup and onboarding utilities.', mode: 'native', churn: 'low' },
];
