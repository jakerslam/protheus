...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/native_daemon/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/native_daemon/index.json',
    events_path: 'client/runtime/local/state/browser/native_daemon/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/native_daemon/latest.json',
    receipts_path: 'client/runtime/local/state/browser/native_daemon/receipts.jsonl',
    daemon_state_path: 'client/runtime/local/state/browser/native_daemon/state.json'
  },
  usage,
  handlers: {
