...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/session_vault/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/session_vault/index.json',
    events_path: 'client/runtime/local/state/browser/session_vault/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/session_vault/latest.json',
    receipts_path: 'client/runtime/local/state/browser/session_vault/receipts.jsonl',
    sessions_path: 'client/runtime/local/state/browser/session_vault/sessions.json'
  },
  usage,
  handlers: {
