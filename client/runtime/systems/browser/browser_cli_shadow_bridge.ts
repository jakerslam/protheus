...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/cli_shadow_bridge/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/cli_shadow_bridge/index.json',
    events_path: 'client/runtime/local/state/browser/cli_shadow_bridge/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/cli_shadow_bridge/latest.json',
    receipts_path: 'client/runtime/local/state/browser/cli_shadow_bridge/receipts.jsonl'
  },
  usage,
  handlers: {
