...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/native_cdp/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/native_cdp/index.json',
    events_path: 'client/runtime/local/state/browser/native_cdp/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/native_cdp/latest.json',
    receipts_path: 'client/runtime/local/state/browser/native_cdp/receipts.jsonl'
  },
  usage,
  handlers: {
