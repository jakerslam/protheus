...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/snapshot_refs/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/snapshot_refs/index.json',
    events_path: 'client/runtime/local/state/browser/snapshot_refs/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/snapshot_refs/latest.json',
    receipts_path: 'client/runtime/local/state/browser/snapshot_refs/receipts.jsonl'
  },
  usage,
  handlers: {
