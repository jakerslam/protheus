...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/browser/policy_gate/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/browser/policy_gate/index.json',
    events_path: 'client/runtime/local/state/browser/policy_gate/events.jsonl',
    latest_path: 'client/runtime/local/state/browser/policy_gate/latest.json',
    receipts_path: 'client/runtime/local/state/browser/policy_gate/receipts.jsonl'
  },
  usage,
  handlers: {
