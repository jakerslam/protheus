...
// Layer ownership: core/layer1/security::external-security-cycle (authoritative)
...
const SECURITY_CMD = 'external-security-cycle';
const bridge = createOpsLaneBridge(__dirname, 'external_security_cycle', 'security-plane');
