...
// Layer ownership: core/layer1/security::formal-invariant-engine (authoritative)
...
const SECURITY_CMD = 'formal-invariant-engine';
const bridge = createOpsLaneBridge(__dirname, 'formal_invariant_engine', 'security-plane');
