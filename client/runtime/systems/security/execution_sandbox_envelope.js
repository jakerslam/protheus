...
// Layer ownership: core/layer1/security::execution-sandbox-envelope (authoritative)
...
const SECURITY_CMD = 'execution-sandbox-envelope';
const bridge = createOpsLaneBridge(__dirname, 'execution_sandbox_envelope', 'security-plane');
