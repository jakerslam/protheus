...
// Layer ownership: core/layer1/security::log-redaction-guard (authoritative)
...
const SECURITY_CMD = 'log-redaction-guard';
const bridge = createOpsLaneBridge(__dirname, 'log_redaction_guard', 'security-plane');
