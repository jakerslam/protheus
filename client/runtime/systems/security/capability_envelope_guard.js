...
// Layer ownership: core/layer1/security::capability-envelope-guard (authoritative)
...
const SECURITY_CMD = 'capability-envelope-guard';
const bridge = createOpsLaneBridge(__dirname, 'capability_envelope_guard', 'security-plane');
