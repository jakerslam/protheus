...
// Layer ownership: core/layer1/security::governance-hardening-lane (authoritative)
...
const SECURITY_CMD = 'governance-hardening-lane';
const bridge = createOpsLaneBridge(__dirname, 'governance_hardening_lane', 'security-plane');
