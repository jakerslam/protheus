...
// Layer ownership: core/layer1/security::goal-preservation-kernel (authoritative)
...
process.env.PROTHEUS_OPS_LOCAL_TIMEOUT_MS =
  process.env.PROTHEUS_OPS_LOCAL_TIMEOUT_MS || '90000';

const SECURITY_CMD = 'goal-preservation-kernel';
const bridge = createOpsLaneBridge(__dirname, 'goal_preservation_kernel', 'security-plane');
...
module.exports = {
  lane: bridge.lane,
  run: (args = []) => bridge.run([SECURITY_CMD, ...args])
};
