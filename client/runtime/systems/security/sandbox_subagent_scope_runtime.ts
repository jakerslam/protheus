...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/security/sandbox_subagent_scope/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/security/sandbox_subagent_scope/index.json',
    events_path: 'client/runtime/local/state/security/sandbox_subagent_scope/events.jsonl',
    latest_path: 'client/runtime/local/state/security/sandbox_subagent_scope/latest.json',
    receipts_path: 'client/runtime/local/state/security/sandbox_subagent_scope/receipts.jsonl',
    state_path: 'client/runtime/local/state/security/sandbox_subagent_scope/state.json'
  },
  usage,
  handlers: {
