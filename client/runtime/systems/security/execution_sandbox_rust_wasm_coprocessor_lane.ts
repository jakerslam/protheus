...
const JS_ENTRY = path.join(__dirname, 'execution_sandbox_rust_wasm_coprocessor_lane.js');
...
export const { run } = require('./execution_sandbox_rust_wasm_coprocessor_lane.js');
