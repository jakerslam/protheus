...
// Layer ownership: core/layer1/security::black-box-ledger (authoritative)
...
const SECURITY_CMD = 'black-box-ledger';
const bridge = createOpsLaneBridge(__dirname, 'black_box_ledger', 'security-plane');
