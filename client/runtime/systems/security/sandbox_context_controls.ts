...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/security/sandbox_context_controls/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/security/sandbox_context_controls/index.json',
    events_path: 'client/runtime/local/state/security/sandbox_context_controls/events.jsonl',
    latest_path: 'client/runtime/local/state/security/sandbox_context_controls/latest.json',
    receipts_path: 'client/runtime/local/state/security/sandbox_context_controls/receipts.jsonl'
  },
  usage,
  handlers: {
