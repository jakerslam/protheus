...
// Layer ownership: core/layer1/security::enterprise-access-gate (authoritative)
...
const SECURITY_CMD = 'enterprise-access-gate';
const bridge = createOpsLaneBridge(__dirname, 'enterprise_access_gate', 'security-plane');
