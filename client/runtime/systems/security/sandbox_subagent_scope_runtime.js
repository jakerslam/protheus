...
const LANE_ID = 'SYSTEMS-SECURITY-SANDBOX-SUBAGENT-SCOPE-RUNTIME';
const bridge = createOpsLaneBridge(__dirname, 'sandbox_subagent_scope_runtime', 'legacy-retired-lane');
