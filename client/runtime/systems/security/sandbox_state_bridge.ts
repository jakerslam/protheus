...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/security/sandbox_state_bridge/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/security/sandbox_state_bridge/index.json',
    events_path: 'client/runtime/local/state/security/sandbox_state_bridge/events.jsonl',
    latest_path: 'client/runtime/local/state/security/sandbox_state_bridge/latest.json',
    receipts_path: 'client/runtime/local/state/security/sandbox_state_bridge/receipts.jsonl',
    snapshots_path: 'client/runtime/local/state/security/sandbox_state_bridge/snapshots.jsonl',
    state_path: 'client/runtime/local/state/security/sandbox_state_bridge/state.json'
  },
  usage,
  handlers: {
