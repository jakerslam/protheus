...
// Layer ownership: core/layer1/security::skill-quarantine (authoritative)
...
const SECURITY_CMD = 'skill-quarantine';
const bridge = createOpsLaneBridge(__dirname, 'skill_quarantine', 'security-plane');
