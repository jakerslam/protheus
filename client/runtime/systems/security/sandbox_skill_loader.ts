...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/security/sandbox_skill_loader/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/security/sandbox_skill_loader/index.json',
    events_path: 'client/runtime/local/state/security/sandbox_skill_loader/events.jsonl',
    latest_path: 'client/runtime/local/state/security/sandbox_skill_loader/latest.json',
    receipts_path: 'client/runtime/local/state/security/sandbox_skill_loader/receipts.jsonl',
    state_path: 'client/runtime/local/state/security/sandbox_skill_loader/state.json'
  },
  usage,
  handlers: {
