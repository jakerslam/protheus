...
// Layer ownership: core/layer1/security::workspace-dump-guard (authoritative)
...
const SECURITY_CMD = 'workspace-dump-guard';
const bridge = createOpsLaneBridge(__dirname, 'workspace_dump_guard', 'security-plane');
