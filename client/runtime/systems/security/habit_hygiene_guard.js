...
// Layer ownership: core/layer1/security::habit-hygiene-guard (authoritative)
...
const SECURITY_CMD = 'habit-hygiene-guard';
const bridge = createOpsLaneBridge(__dirname, 'habit_hygiene_guard', 'security-plane');
