...
// Layer ownership: core/layer1/security::repository-access-auditor (authoritative)
...
const SECURITY_CMD = 'repository-access-auditor';
const bridge = createOpsLaneBridge(__dirname, 'repository_access_auditor', 'security-plane');
