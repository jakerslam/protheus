...
const SYSTEM_ID = 'SYSTEMS-FRACTAL-SYMBIOTIC_FUSION_CHAMBER';
const MAX_ARGS = 64;
const MAX_ARG_LEN = 512;
const bridge = createOpsLaneBridge(__dirname, 'symbiotic_fusion_chamber', 'runtime-systems', {
  inheritStdio: true
});
