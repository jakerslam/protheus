...
function defaultPaths() {
  return {
    ...
    rollback_script: resolvePath('client/runtime/systems/autonomy/gated_self_improvement_loop.js', 'client/runtime/systems/autonomy/gated_self_improvement_loop.js')
  };
}
