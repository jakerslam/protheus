...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/shadow/signal_classifier/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/shadow/signal_classifier/index.json',
    events_path: 'client/runtime/local/state/shadow/signal_classifier/events.jsonl',
    latest_path: 'client/runtime/local/state/shadow/signal_classifier/latest.json',
    receipts_path: 'client/runtime/local/state/shadow/signal_classifier/receipts.jsonl'
  },
  usage,
  handlers: {
