...
const bridge = createCompatTargetBridge({
  scriptDir: __dirname,
  targetRelativePath: '../../../../surface/orchestration/scripts/task_decomposition_primitive.ts',
  loadError: 'task_decomposition_primitive_target_load_failed',
  unavailableError: 'task_decomposition_primitive_target_unavailable',
  missingRunError: 'task_decomposition_primitive_target_missing_run',
  maxArgs: MAX_ARGS,
