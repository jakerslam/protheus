...
// Layer ownership: core/layer2/autonomy + core/layer0/ops::red-legion-domain (authoritative)
const { createDomainProxy } = require('../../lib/legacy_conduit_proxy');

const runDomain = createDomainProxy(__dirname, 'RED_LEGION', 'red-legion');
...
function runChaosGame(request, _opts = {}) {
