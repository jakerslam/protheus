...
const LANE_ID = 'SYSTEMS-OPS-PERMANENT-GUIDELINES-DRIFT-GATE';
const bridge = createOpsLaneBridge(__dirname, 'permanent_guidelines_drift_gate', 'legacy-retired-lane');
