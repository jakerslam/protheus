...
const JS_ENTRY = path.join(__dirname, 'ngc_nvidia_enterprise_distribution_adapter.js');
...
export const { run } = require('./ngc_nvidia_enterprise_distribution_adapter.ts');
