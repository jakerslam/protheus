...
const JS_ENTRY = path.join(__dirname, 'rust_authoritative_microkernel_acceleration.js');
...
export const { run } = require('./rust_authoritative_microkernel_acceleration.ts');
