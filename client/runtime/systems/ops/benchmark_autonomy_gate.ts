...
function defaultPolicy() {
  return {
    ...
    paths: {
      state_root: 'client/runtime/local/state/ops/benchmark_autonomy_gate',
      latest_path: 'client/runtime/local/state/ops/benchmark_autonomy_gate/latest.json',
      receipts_path: 'client/runtime/local/state/ops/benchmark_autonomy_gate/receipts.jsonl',
      benchmark_history_path: 'client/runtime/local/state/ops/public_benchmarks/results.jsonl',
      autonomy_queue_path: 'client/runtime/local/state/ops/benchmark_autonomy_gate/backlog_queue.json',
      metadata_contract_path: 'client/runtime/local/state/ops/benchmark_autonomy_gate/backlog_metadata.json'
    }
  };
}
