...
function actionsForToday(): Action[] {
  ...
  return [
    ...
    { roi_rank: 37, id: 'compliance_posture_strict', command: 'npm run compliance:posture:status' },
    { roi_rank: 38, id: 'compliance_posture_status', command: 'npm run compliance:posture:status' },
    { roi_rank: 39, id: 'deploy_package_strict', command: 'npm run deploy:package:status' },
    ...
    { roi_rank: 42, id: 'docs_coverage_gate', command: 'node systems/ops/docs_coverage_gate.js run --strict=0' },
    { roi_rank: 43, id: 'handoff_pack', command: 'npm run handoff:pack' },
    { roi_rank: 44, id: 'handoff_simulate', command: 'node systems/ops/handoff_pack.js simulate --strict=0' },
