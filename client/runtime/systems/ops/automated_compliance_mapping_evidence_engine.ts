...
const JS_ENTRY = path.join(__dirname, 'automated_compliance_mapping_evidence_engine.js');
...
export const { run } = require('./automated_compliance_mapping_evidence_engine.ts');
