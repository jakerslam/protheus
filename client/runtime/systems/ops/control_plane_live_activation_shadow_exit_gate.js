...
const LANE_ID = 'SYSTEMS-OPS-CONTROL-PLANE-LIVE-ACTIVATION-SHADOW-EXIT-GATE';
const bridge = createOpsLaneBridge(__dirname, 'control_plane_live_activation_shadow_exit_gate', 'legacy-retired-lane');
