...
const LANE_ID = 'SYSTEMS-OPS-AUTOMATED-COMPLIANCE-MAPPING-EVIDENCE-ENGINE';
const bridge = createOpsLaneBridge(__dirname, 'automated_compliance_mapping_evidence_engine', 'legacy-retired-lane');
