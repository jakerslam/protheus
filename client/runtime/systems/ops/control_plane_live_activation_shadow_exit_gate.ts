...
const JS_ENTRY = path.join(__dirname, 'control_plane_live_activation_shadow_exit_gate.js');
...
export const { run } = require('./control_plane_live_activation_shadow_exit_gate.js');
