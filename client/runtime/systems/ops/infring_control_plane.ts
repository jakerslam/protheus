...
// Layer ownership: core/layer0/ops::infring-control-plane (authoritative domain route).

const mod = require('../../../../adapters/runtime/infring_cli_modules.ts').infringControlPlane;
