...
const LANE_ID = 'SYSTEMS-OPS-FULL-PIPELINE-E2E-HARDENING-PACK';
const bridge = createOpsLaneBridge(__dirname, 'full_pipeline_e2e_hardening_pack', 'legacy-retired-lane');
