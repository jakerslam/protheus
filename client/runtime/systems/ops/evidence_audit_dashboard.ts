...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/ops/evidence_audit_dashboard/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/ops/evidence_audit_dashboard/index.json',
    events_path: 'client/runtime/local/state/ops/evidence_audit_dashboard/events.jsonl',
    latest_path: 'client/runtime/local/state/ops/evidence_audit_dashboard/latest.json',
    receipts_path: 'client/runtime/local/state/ops/evidence_audit_dashboard/receipts.jsonl',
    export_json_path: 'client/runtime/local/state/ops/evidence_audit_dashboard/export.json',
    export_md_path: 'client/runtime/local/state/ops/evidence_audit_dashboard/export.md'
  },
  usage,
  handlers: {
