...
const LANE_ID = 'SYSTEMS-OPS-CONTINUOUS-CHAOS-AUTO-REMEDIATION-SUITE';
const bridge = createOpsLaneBridge(__dirname, 'continuous_chaos_auto_remediation_suite', 'legacy-retired-lane');
