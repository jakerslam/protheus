...
runStandardLane({
  ...
  paths: {
    memory_dir: 'client/runtime/local/state/ops/competitive_benchmark_matrix/memory',
    adaptive_index_path: 'client/runtime/local/adaptive/ops/competitive_benchmark_matrix/index.json',
    events_path: 'client/runtime/local/state/ops/competitive_benchmark_matrix/events.jsonl',
    latest_path: 'client/runtime/local/state/ops/competitive_benchmark_matrix/latest.json',
    receipts_path: 'client/runtime/local/state/ops/competitive_benchmark_matrix/receipts.jsonl',
    snapshots_path: 'client/runtime/local/state/ops/competitive_benchmark_matrix/snapshots.jsonl'
  },
  usage,
  handlers: {
    run(policy: any, args: any, ctx: any) {
      ...
      const snapshot = {
        ...
        subbench_runs: runs,
        claim_evidence: [
          'client/runtime/systems/ops/competitive_observability_benchmark_pack.ts',
