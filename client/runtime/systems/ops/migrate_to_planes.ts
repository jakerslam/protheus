...
function usage() {
  console.log('Usage:');
  console.log('  node client/runtime/systems/ops/migrate_to_planes.js run [--apply=0|1] [--move-untracked=1|0] [--include-missing=0|1] [--compat-symlinks=1|0 (deprecated, default 0)]');
  console.log('  node client/runtime/systems/ops/migrate_to_planes.js rollback --id=<migration_id|latest> [--prune-copies=1|0]');
  console.log('  node client/runtime/systems/ops/migrate_to_planes.js status');
  console.log('  node client/runtime/systems/ops/migrate_to_planes.js plan');
}
