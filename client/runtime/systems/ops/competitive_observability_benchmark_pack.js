...
const LANE_ID = 'SYSTEMS-OPS-COMPETITIVE-OBSERVABILITY-BENCHMARK-PACK';
const bridge = createOpsLaneBridge(__dirname, 'competitive_observability_benchmark_pack', 'legacy-retired-lane');
