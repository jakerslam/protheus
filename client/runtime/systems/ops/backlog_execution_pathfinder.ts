...
const DEFAULT_POLICY_PATH = process.env.BACKLOG_EXECUTION_PATHFINDER_POLICY_PATH
  ...
  : (() => {
      const migrated = path.join(ROOT, 'client', 'runtime', 'config', 'backlog_execution_pathfinder_policy.json');
...
function defaultPolicy() {
  return {
    ...
    outputs: {
      ...
      report_md_path: 'docs/client/backlog_views/execution_path.md'
    }
  };
}
