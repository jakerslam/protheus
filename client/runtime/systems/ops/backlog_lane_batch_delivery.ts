...
const DEFAULT_POLICY_PATH = process.env.BACKLOG_LANE_BATCH_DELIVERY_POLICY_PATH
  ...
  : (() => {
      const migrated = path.join(ROOT, 'client', 'runtime', 'config', 'backlog_lane_batch_delivery_policy.json');
...
function defaultPolicy() {
  return {
    ...
    enabled: true,
    strict_default: true,
    source_registry_path: 'client/runtime/config/backlog_registry.json',
    review_registry_path: 'client/runtime/config/backlog_review_registry.json',
