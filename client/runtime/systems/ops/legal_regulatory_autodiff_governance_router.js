...
const LANE_ID = 'SYSTEMS-OPS-LEGAL-REGULATORY-AUTODIFF-GOVERNANCE-ROUTER';
const bridge = createOpsLaneBridge(__dirname, 'legal_regulatory_autodiff_governance_router', 'legacy-retired-lane');
