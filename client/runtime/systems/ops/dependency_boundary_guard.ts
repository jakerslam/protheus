...
const GUARD_SCRIPT = path.resolve(WORKSPACE_ROOT, 'scripts/ci/dependency_boundary_guard.mjs');
...
export function run(argv = []) {
  ...
  return { ok: true, delegated_to: 'scripts/ci/dependency_boundary_guard.mjs' };
}
