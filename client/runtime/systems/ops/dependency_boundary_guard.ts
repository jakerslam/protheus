...
const DEFAULT_POLICY_PATH = process.env.DEPENDENCY_BOUNDARY_MANIFEST_PATH
  ...
  : path.join(ROOT, 'client', 'runtime', 'config', 'dependency_boundary_manifest.json');
  ...
  return {
    ...
    conduit_boundary: {
      ...
      allowlisted_files: [
        ...
        'client/runtime/systems/ops/rust50_sprint_contract.js',
        'client/runtime/systems/ops/rust_hybrid_migration_program.ts',
        'client/runtime/systems/conduit/conduit-client.ts',
        'client/runtime/systems/conduit/conduit-client.js'
      ],
      forbidden_patterns: [
    ...
    paths: {
      latest_path: 'client/runtime/local/state/ops/dependency_boundary_guard/latest.json',
      receipts_path: 'client/runtime/local/state/ops/dependency_boundary_guard/receipts.jsonl'
    }
  };
}
