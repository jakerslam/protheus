...
function usage() {
  console.log('Usage:');
  console.log('  node client/runtime/systems/ops/runtime_state_surface_guard.js check [--strict=1|0]');
  console.log('  node client/runtime/systems/ops/runtime_state_surface_guard.js status');
}
...
function defaultPolicy() {
  return {
    ...
    outputs: {
      latest_path: 'client/runtime/local/state/ops/runtime_state_surface_guard/latest.json',
      receipts_path: 'client/runtime/local/state/ops/runtime_state_surface_guard/receipts.jsonl'
    }
  };
}
