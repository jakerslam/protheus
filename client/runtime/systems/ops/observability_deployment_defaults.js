...
const LANE_ID = 'SYSTEMS-OPS-OBSERVABILITY-DEPLOYMENT-DEFAULTS';
const bridge = createOpsLaneBridge(__dirname, 'observability_deployment_defaults', 'legacy-retired-lane');
