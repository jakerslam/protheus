...
function usage() {
  console.log('Usage:');
  console.log('  node client/runtime/systems/ops/migrate_cleanup.js plan');
  console.log('  node client/runtime/systems/ops/migrate_cleanup.js run [--apply=1|0] [--strict=1|0]');
  console.log('  node client/runtime/systems/ops/migrate_cleanup.js status');
}
