...
const bridge = createCompatTargetBridge({
  scriptDir: __dirname,
  targetRelativePath: '../../../../surface/orchestration/scripts/route_task.ts',
  loadError: 'route_task_target_load_failed',
  unavailableError: 'route_task_target_unavailable',
  missingRunError: 'route_task_target_missing_run',
  maxArgs: 64,
  maxArgLen: 512
});
