...
const SYSTEM_ID = 'SYSTEMS-SENSORY-FEATURE_DATA_REPRODUCIBILITY_CONTRACT';
const bridge = createOpsLaneBridge(__dirname, 'feature_data_reproducibility_contract', 'runtime-systems', {
  inheritStdio: true
});
