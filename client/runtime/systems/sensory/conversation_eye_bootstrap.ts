...
function usage() {
  console.log('Usage:');
  console.log('  node client/runtime/systems/sensory/conversation_eye_bootstrap.js ensure [--apply=1]');
  console.log('  node client/runtime/systems/sensory/conversation_eye_bootstrap.js plan');
  console.log('  node client/runtime/systems/sensory/conversation_eye_bootstrap.js status');
}
...
function main() {
  ...
  process.stdout.write(`${JSON.stringify({
    ...
    usage: 'node client/runtime/systems/sensory/conversation_eye_bootstrap.js ensure|plan|status'
  }, null, 2)}\n`);
  process.exit(1);
}
