...
const SYSTEM_ID = 'SYSTEMS-SENSORY-DETECTOR_ERROR_TAXONOMY_AUTOTUNE';
const bridge = createOpsLaneBridge(__dirname, 'detector_error_taxonomy_autotune', 'runtime-systems', {
  inheritStdio: true
});
