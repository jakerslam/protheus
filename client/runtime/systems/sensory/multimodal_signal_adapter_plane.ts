...
const SYSTEM_ID = 'SYSTEMS-SENSORY-MULTIMODAL_SIGNAL_ADAPTER_PLANE';
const bridge = createOpsLaneBridge(__dirname, 'multimodal_signal_adapter_plane', 'runtime-systems', {
  inheritStdio: true
});
