...
const SYSTEM_ID = 'SYSTEMS-SENSORY-NOVELTY_SATURATION_PRIORITIZATION_ENGINE';
const bridge = createOpsLaneBridge(__dirname, 'novelty_saturation_prioritization_engine', 'runtime-systems', {
  inheritStdio: true
});
