...
| `support_envelope_template_present` | PASS | `support template exists` | `present` | `client/docs/ENTERPRISE_SUPPORT_ENVELOPE_TEMPLATE.md` |
| `case_study_template_present` | PASS | `case study template exists` | `present` | `client/docs/REFERENCE_CUSTOMER_CASE_STUDY_TEMPLATE.md` |
| `legal_packet_checklist_present` | PASS | `legal packet checklist exists` | `present` | `client/docs/LEGAL_ENTERPRISE_PACKET_CHECKLIST.md` |
| `human_owner_blockers_registered` | PASS | `all markers present: HMAN-026, HMAN-027, HMAN-028, HMAN-029, HMAN-030, HMAN-031, HMAN-032, HMAN-033, HMAN-034, HMAN-035` | `all_markers_present` | `client/docs/HUMAN_ONLY_ACTIONS.md` |
