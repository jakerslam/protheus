...
|---|---|---|---|
| `client/systems/` | Control plane + safety infrastructure | No direct adaptive writes except controller stores | N/A |
| `client/adaptive/` | Runtime-adaptive policy/state data | Data only (no arbitrary writes) | `client/systems/adaptive/*/*_store.js` |
...
- `client/systems/adaptive/core/layer_store.js`
- `client/systems/adaptive/sensory/eyes/catalog_store.js`
- `client/systems/adaptive/sensory/eyes/focus_trigger_store.js`
- `client/systems/adaptive/habits/habit_store.js`
- `client/systems/adaptive/reflex/reflex_store.js`
- `client/systems/adaptive/strategy/strategy_store.js`

Guard policy:

- `client/systems/sensory/adaptive_layer_guard.js`
- `client/config/adaptive_layer_guard_policy.json`
...
- `client/config/contracts/autonomy_receipt.schema.json`
- `client/config/contracts/proposal_admission.schema.json`
- `client/config/contracts/adaptive_store.schema.json`

Validation entrypoint:

- `node client/systems/security/schema_contract_check.js run`

CI executes this check before general test execution.

## Design Rules

1. `client/systems/` should remain broadly reusable; no business specialization in system modules.
