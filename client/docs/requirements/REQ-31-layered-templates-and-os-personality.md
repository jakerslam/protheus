...
- `ARCHITECTURE.md`, `docs/SYSTEM-ARCHITECTURE-SPECS.md`, `planes/README.md`, and `client/docs/architecture/LAYER_RULEBOOK.md` must stay aligned with the same layer map.
