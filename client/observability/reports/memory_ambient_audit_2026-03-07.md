...
- `client/runtime/config/napi_build_surface_compat_policy.json` keeps `cli_compat` as an explicit diagnostics-only profile.
...
- Last available benchmark artifact remains at `client/runtime/local/state/ops/mech_suit_benchmark/latest.json`.
