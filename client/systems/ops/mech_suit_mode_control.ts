...
function usage() {
  console.log('Usage:');
  console.log('  node client/systems/ops/mech_suit_mode_control.ts status');
  console.log('  node client/systems/ops/mech_suit_mode_control.ts on');
  console.log('  node client/systems/ops/mech_suit_mode_control.ts off');
  console.log('  node client/systems/ops/mech_suit_mode_control.ts set --enabled=1|0');
}
