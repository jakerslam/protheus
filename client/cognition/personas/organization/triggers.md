...
- Route: `infring lens trigger pre-sprint "<goal or plan>"`
...
- Route: `infring lens trigger drift-alert "<drift context>"`
...
- Route: `infring lens trigger weekly-checkin --persona=jay_haslam --heartbeat=local/workspace/assistant/HEARTBEAT.md`
