...
- `entrypoint` — must be client/cognition/habits/routines/<id>.js
...
- `client/cognition/habits/registry.json` — State machine + metrics
- `client/cognition/habits/routines/` — Habit code (routines)
- `client/cognition/habits/routines/_archived/` — Archived routines
- `client/cognition/habits/scripts/` — Infrastructure (runner, doctor, GC, proposer)
- `client/runtime/local/logs/habits/habit_runs.ndjson` — Execution log with outcome_score/delta_value
- `client/runtime/local/logs/habits/habit_errors.ndjson` — Error log

## Schema Reference

See `client/cognition/habits/registry.json` for full schema:
- `version`: 1.5
- `max_active`: 25
