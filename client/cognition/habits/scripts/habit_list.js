...
const REGISTRY_PATH = '/Users/jay/.openclaw/workspace/client/cognition/habits/registry.json';
...
function main() {
  ...
  console.log('');
  console.log('USAGE:');
  console.log('  node client/cognition/habits/scripts/run_habit.js --list');
  console.log('  node client/cognition/habits/scripts/run_habit.js --id <habit_id> --json \'{}\'');
  console.log('  node client/cognition/habits/scripts/habit_list.js --trusted');
  console.log('');
}
