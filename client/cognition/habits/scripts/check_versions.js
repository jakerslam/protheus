 ...
 * 
 * Usage: node client/cognition/habits/scripts/check_versions.js
 *        node client/cognition/habits/scripts/check_versions.js --check <layer>
 */
...
function printAllVersions() {
  ...
  console.log('═══════════════════════════════════════');
  console.log('To update a layer: edit file, then update client/runtime/config/layer_versions.json');
}
