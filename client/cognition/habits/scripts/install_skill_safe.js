#!/usr/bin/env node
/**
 * client/cognition/habits/scripts/install_skill_safe.js
 *
 * Safe wrapper for skill installation:
 * - Policy-gated spec validation (client/runtime/systems/security/skill_quarantine.js)
...
function usage() {
  console.log('Usage:');
  console.log('  node client/cognition/habits/scripts/install_skill_safe.js --spec "<source>" [--approve=1 --approval_note "..."] [--autonomous=1 --justification-file <file>|--justification-json "<json>"] [--dry-run]');
  console.log('');
  console.log('Examples:');
  console.log('  node client/cognition/habits/scripts/install_skill_safe.js --spec "github:org/repo/skill" --dry-run');
  console.log('  node client/cognition/habits/scripts/install_skill_safe.js --spec "github:org/repo/skill" --approve=1 --approval_note "Reviewed manifest + risky markers"');
  console.log('  node client/cognition/habits/scripts/install_skill_safe.js --spec "github:org/repo/skill" --autonomous=1 --justification-file "./state/autonomy/skill_justification.json" --dry-run');
}
