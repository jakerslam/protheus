 ...
 *
 * Usage:
 *   node client/cognition/habits/scripts/eyes_inventory.js
 *   node client/cognition/habits/scripts/eyes_inventory.js --json
 *   node client/cognition/habits/scripts/eyes_inventory.js --help
 */
...
function usage() {
  console.log('Usage:');
  console.log('  node client/cognition/habits/scripts/eyes_inventory.js');
  console.log('  node client/cognition/habits/scripts/eyes_inventory.js --json');
  console.log('  node client/cognition/habits/scripts/eyes_inventory.js --help');
  console.log('');
