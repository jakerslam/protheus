 ...
 *
 * Usage:
 *   node client/cognition/habits/scripts/reflex_habit_bridge.js sync [--apply=1]
 *   node client/cognition/habits/scripts/reflex_habit_bridge.js gc [--apply=1]
 *   node client/cognition/habits/scripts/reflex_habit_bridge.js status
 *   node client/cognition/habits/scripts/reflex_habit_bridge.js --help
 */
...
function usage() {
  console.log('Usage:');
  console.log('  node client/cognition/habits/scripts/reflex_habit_bridge.js sync [--apply=1]');
  console.log('  node client/cognition/habits/scripts/reflex_habit_bridge.js gc [--apply=1]');
  console.log('  node client/cognition/habits/scripts/reflex_habit_bridge.js status');
}
