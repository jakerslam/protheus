...
function main() {
  ...
  switch (cmd) {
    ...
    default: {
      ...
      console.log('');
      console.log('Usage:');
      console.log('  node client/cognition/habits/scripts/sensory_digest.js daily [YYYY-MM-DD]');
      console.log('  node client/cognition/habits/scripts/sensory_digest.js weekly [YYYY-MM-DD]');
      console.log('');
      console.log('Outputs:');
