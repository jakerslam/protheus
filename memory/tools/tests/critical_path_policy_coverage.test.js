...
function main() {
  ...
  const mergeGuardPath = path.join(tmp, 'systems', 'security', 'merge_guard.ts');
  ...
  write(mergeGuardPath, '// merge_guard hook includes sample_lane.js\nconst HOOK = "sample_lane.js";\n');
  ...
  write(mergeGuardPath, '// hook intentionally removed\n');
