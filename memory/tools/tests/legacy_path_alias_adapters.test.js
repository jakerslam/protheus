...
try {
  ...
  assert.ok(receiptRows.some((row) => row.alias_path === 'systems/state/event_stream.js'), 'event_stream alias receipt missing');
  assert.ok(receiptRows.some((row) => row.alias_path === 'systems/autogenesis/trace_habit_autogenesis.js'), 'trace_habit_autogenesis alias receipt missing');
  assert.ok(receiptRows.some((row) => row.alias_path === 'systems/autogenesis/trace_habit_loop.js'), 'trace_habit_loop alias receipt missing');
