...
function main() {
  ...
  writeJson(distPolicy, {
    ...
    package_cmd: ['node', 'systems/ops/protheus_prime_seed.js', 'status'],
    verify_cmd: ['node', 'systems/ops/protheus_prime_seed.js', 'status'],
    paths: {
  ...
  writeJson(econPolicy, {
    ...
    storm_plan_cmd: ['node', 'systems/storm/storm_value_distribution.js', 'status'],
    paths: {
