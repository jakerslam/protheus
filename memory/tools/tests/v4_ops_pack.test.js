...
function main() {
  ...
  writeJson(formalPolicy, {
    ...
    required_paths: ['systems/spine/spine.js'],
    verifier_cmd: ['node', 'systems/security/critical_path_formal_verifier.js', 'status'],
    paths: {
  ...
  writeJson(parityPolicy, {
    ...
    remediation_limit: 4,
    parity_cmd: ['node', 'systems/ops/narrow_agent_parity_harness.js', 'status', 'latest'],
    paths: {
