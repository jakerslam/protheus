...
`);
  ...
  writeJson(policyPath, {
    ...
    mutation_domains: [
      { id: 'habit_code', target_path: 'systems/a.ts', risk: 'medium', summary: 'm1' },
      { id: 'memory_schema', target_path: 'systems/b.ts', risk: 'medium', summary: 'm2' },
      { id: 'routing_policy', target_path: 'systems/c.ts', risk: 'medium', summary: 'm3' }
    ],
    scripts: {
