    ...
    themes: [
      {
        ...
        score: 19,
        rows: [
          { memory_file: 'memory/2026-02-19.md', node_id: 'graph-bridge-policy' },
          { memory_file: 'memory/2026-02-19.md', node_id: 'node-format-policy' }
        ],
        older_refs: [
          { file: 'memory/2026-02-13.md', node_id: 'graph-bridge-policy', summary: 'Bridge policy' }
        ]
      }
    ]
  });
    ...
    themes: [
      {
        ...
        rows: [
          ...
          { memory_file: 'memory/2026-02-20.md', node_id: 'memory-dream' }
        ],
        older_refs: [
          { file: 'memory/2026-02-13.md', node_id: 'retrieval-rails', summary: 'Retrieval rails' }
        ]
      }
    ]
  });
