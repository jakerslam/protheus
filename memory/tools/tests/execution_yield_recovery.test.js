    ...
    proposals: [
      {
        ...
        action_spec: {
          ...
          next_command: 'node habits/scripts/proposal_queue.js accept P-HIGH1 "ship now"',
      ...
      },
      {
        ...
        suggested_next_command: 'node habits/scripts/proposal_queue.js accept P-MISS "recover missing spec"'
      },
      {
        id: 'P-LOW1',
