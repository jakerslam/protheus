...
try {
  ...
  writeText(path.join(tmp, 'README.md'), [
    'See ARCHITECTURE.md',
    'See docs/DEVELOPER_LANE_QUICKSTART.md',
    'See docs/HELP.md'
  ].join('\n'));
  writeText(path.join(tmp, 'ARCHITECTURE.md'), 'Hub: docs/README.md\n');
  writeText(path.join(tmp, 'CONTRIBUTING.md'), 'Use docs/DEVELOPER_LANE_QUICKSTART.md\n');
