...
function runTests() {
  ...
  try {
    ...
    execSync('node habits/scripts/sensory_capture.js note "Test note from sensory capture test"', {
  ...
  try {
    ...
    // Add more notes
    execSync('node habits/scripts/sensory_capture.js note "Second note"', {
      cwd: path.join(__dirname, '..', '..', '..'),
      encoding: 'utf8'
    });
    execSync('node habits/scripts/sensory_capture.js note "Third note"', {
      cwd: path.join(__dirname, '..', '..', '..'),
      encoding: 'utf8'
    });
  ...
  try {
    ...
    const output = execSync('node habits/scripts/sensory_capture.js show --days=1', {
      cwd: path.join(__dirname, '..', '..', '..'),
      encoding: 'utf8'
    });
  ...
  try {
    ...
    try {
      const output = execSync('node habits/scripts/sensory_capture.js capture', {
        cwd: path.join(__dirname, '..', '..', '..'),
        encoding: 'utf8'
      });
