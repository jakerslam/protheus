...
try {
  ...
  writeText(path.join(tmp, 'README.md'), 'See docs/ORG_CODE_FORMAT_STANDARD.md for style.');
  writeText(path.join(tmp, 'docs', 'README.md'), 'See ORG_CODE_FORMAT_STANDARD.md for docs style.');
  writeText(path.join(tmp, 'CONTRIBUTING.md'), 'Use docs/ORG_CODE_FORMAT_STANDARD.md before PR.');
