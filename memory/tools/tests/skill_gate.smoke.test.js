...
function runTests() {
  ...
  try {
    ...
    const trustedFile = '/Users/jay/.openclaw/workspace/memory/tools/skill_gate.js';
  ...
  try {
    ...
    execSync(`node /Users/jay/.openclaw/workspace/memory/tools/trust_add.js ${copyFile} "test copy for hash mismatch test"`, {
      encoding: 'utf8',
      stdio: 'pipe'
    });
