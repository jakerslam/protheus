...
function main() {
  ...
  const required = runRust({
    habit_state: 'active',
    entrypoint_resolved: '/repo/habits/scripts/run_habit.js',
    trusted_entrypoints: ['/repo/habits/scripts/run_habit.js'],
  ...
  const untrusted = runRust({
    ...
    entrypoint_resolved: '/repo/habits/scripts/untrusted.js',
    trusted_entrypoints: ['/repo/habits/scripts/run_habit.js'],
    required_inputs: []
  });
