...
try {
    ...
    rows: [
      {
        ...
        problem: 'x',
        acceptance: '`systems/foo.js` + `config/foo.json` + `memory/tools/tests/foo.test.js`',
        dependencies: []
      },
      {
        id: 'V3-RACE-901',
        ...
        title: 'wrapper only',
        problem: 'x',
        acceptance: '`systems/wrapper_only.js`',
        dependencies: []
      },
      {
        id: 'V2-012',
  ...
  writeJson(policyPath, {
    ...
    search: {
      roots: ['systems', 'config', 'docs', 'memory/tools/tests'],
      exclude_paths: ['config/backlog_registry.json', 'docs/backlog_views/reviewed.md']
    }
  });
