...
try {
  ...
  writeJson(adaptersPath, {
    ...
    adapters: {
      shared_http: {
        module: 'systems/actuation/multi_channel_adapter.js',
        description: 'shared http'
      },
      bespoke_legacy: {
        module: 'systems/actuation/legacy_one_off_adapter.js',
  ...
  writeJson(policyPath, {
    ...
    shared_module_hints: ['systems/actuation/multi_channel_adapter.js'],
    exempt_adapters: []
  });
