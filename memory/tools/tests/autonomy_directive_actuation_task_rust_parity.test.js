...
function run() {
  const clarificationSamples = [
    ...
    },
    {
      ...
      suggested_next_command: "node systems/security/directive_intake.js validate --file=config/directives/quant_intel_acquisition.yaml"
    },
    {
  ...
  const decompositionSamples = [
    ...
    },
    {
      proposal_type: 'directive_decomposition',
      meta_directive_objective_id: '',
      suggested_next_command: "node systems/security/directive_intake.js decompose --id=T3_ALPHA"
    },
    {
      proposal_type: 'route_execute',
      meta_directive_objective_id: '',
