...
const criticalFiles = [
  '~/.openclaw/workspace/config/model_adapters.json',
  ...
  '~/.openclaw/workspace/memory/tools/lint_memory.js',
  '~/.openclaw/workspace/memory/tools/rebuild_exclusive.js'
];
...
console.log('  ☐ ~/.openclaw/workspace/memory/ (nodes + indices + tools)');
console.log('  ☐ ~/.openclaw/workspace/skills/ (if custom)');
console.log('  ☐ ~/.openclaw/workspace/config/ (model_adapters.json + credentials)');
...
');
console.log('    ~/.openclaw/workspace/config/');
console.log();
console.log('Restore test:');
console.log('  1) Install OpenClaw + deps on new machine');
console.log('  2) Restore backup directories');
console.log('  3) Run: node memory/tools/lint_memory.js');
console.log('  4) Run: node memory/tools/rebuild_exclusive.js');
