...
const ALLOWED_FILES = [
  'lib/exec_compacted.js',  // The authorized wrapper
  'memory/tools/skill_runner.js', // Uses spawn for child process management (legitimate)
];
      ...
      if (pattern.test(line)) {
        ...
        if (!isAllowed) {
          findings.push({
            ...
            code: line.trim(),
            fix: 'Use execCompacted() or execFileCompacted() from lib/exec_compacted.js'
          });
        }
      }
    }
