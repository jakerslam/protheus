...
#system → model-bootstrap, self-model-spec, project-registry, test-noise-quarantine, bridge-templates, bloat-safeguards, node-format-policy, snippet-index-policy, tagging-policy, topic-registry, pin-policy, capture-policy, agent-portability-spec, retrieval-rails, system-changelog, portability-playbook, decision-journal-policy
