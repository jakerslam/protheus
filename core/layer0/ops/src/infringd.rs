...
include!("infringd_parts/010-print-json.rs");
include!("infringd_parts/020-validate-swarm-profile.rs");
include!("infringd_parts/030-embedded-minimal-core-status.rs");
