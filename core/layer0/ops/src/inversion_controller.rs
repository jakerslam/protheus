...
const REPLACEMENT: &str = "infring-ops inversion-controller";
...
fn usage() {
    println!("Usage:");
    println!("  infring-ops inversion-controller status");
    println!("  infring-ops inversion-controller run [--objective=<id>] [--impact=<low|medium|high>] [--target=<lane>]");
}
