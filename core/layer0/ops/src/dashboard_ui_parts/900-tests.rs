...
fn dashboard_troubleshooting_summary_exposes_lane_health_and_recovery_hints() {
    ...
    dashboard_assert_bool_keys_with_prefix(
        ...
        "tooling_response_gate_next_action_command_consistent",
        "tooling_response_gate_next_action_command_known",
        "tooling_response_gate_next_action_lane_consistent",
        ...
        "tooling_response_gate_retry_class_consistent",
        "tooling_response_gate_retry_class_known",
        "tooling_response_gate_retry_command_consistent",
        "tooling_response_gate_retry_window_consistent",
        "tooling_response_gate_retry_signature_consistent",
        "tooling_response_gate_retry_signature_known",
        "tooling_response_gate_lane_retry_window_consistent",
        "tooling_response_gate_retry_band_consistent",
        "tooling_response_gate_retry_mode_consistent",
        "tooling_response_gate_retry_mode_known",
        "tooling_response_gate_retry_action_vector_consistent",
        "tooling_response_gate_retry_budget_consistent",
        "tooling_response_gate_retry_budget_non_negative",
        "tooling_response_gate_retry_budget_band_consistent",
        "tooling_response_gate_retry_budget_expected_band_consistent",
        "tooling_response_gate_retry_budget_range_consistent",
        "tooling_response_gate_retry_budget_mode_consistent",
        "tooling_response_gate_retry_pressure_tier_consistent",
        "tooling_response_gate_retry_pressure_tier_known",
        "tooling_response_gate_retry_budget_vector_consistent",
        "tooling_response_gate_retry_budget_vector_known",
        "tooling_response_gate_retry_tier_window_consistent",
        "tooling_response_gate_retry_tier_mode_consistent",
        "tooling_response_gate_retry_tier_vector_consistent",
        "tooling_response_gate_retry_tier_vector_known",
        "tooling_response_gate_retry_contract_vector_consistent",
        "tooling_response_gate_retry_contract_vector_known",
        "tooling_response_gate_retry_contract_family_consistent",
        "tooling_response_gate_retry_contract_severity_consistent",
        "tooling_response_gate_retry_contract_coherence_consistent",
        "tooling_response_gate_retry_contract_lane_class_consistent",
        "tooling_response_gate_retry_contract_command_class_consistent",
        "tooling_response_gate_retry_contract_expected_class_consistent",
        "tooling_response_gate_retry_contract_pressure_class_consistent",
        "tooling_response_gate_retry_contract_expected_pressure_class_consistent",
        "tooling_response_gate_retry_contract_expected_command_class_consistent",
        "tooling_response_gate_retry_contract_expected_mode_class_consistent",
        "tooling_response_gate_retry_contract_expected_after_seconds_class_consistent",
        "tooling_response_gate_retry_contract_expected_after_seconds_band_class_consistent",
        "tooling_response_gate_retry_contract_expected_after_seconds_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_mode_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_lane_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_command_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_pressure_class_inverse_consistent",
        "tooling_response_gate_retry_contract_expected_command_mode_consistent",
        "tooling_response_gate_retry_contract_expected_after_seconds_mode_consistent",
        "tooling_response_gate_retry_contract_expected_lane_after_seconds_consistent",
        "tooling_response_gate_retry_contract_expected_command_after_seconds_consistent",
        "tooling_response_gate_retry_contract_expected_lane_command_after_seconds_consistent",
        "tooling_response_gate_retry_contract_expected_lane_command_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_lane_mode_pressure_consistent",
        "tooling_response_gate_retry_contract_expected_lane_command_mode_consistent",
        "tooling_response_gate_retry_contract_expected_lane_command_consistent",
        "tooling_response_gate_retry_contract_expected_lane_command_class_consistent",
        "tooling_response_gate_retry_contract_expected_lane_mode_class_consistent",
        "tooling_response_gate_retry_contract_expected_lane_class_consistent",
        "tooling_response_gate_retry_after_seconds_consistent",
        "tooling_response_gate_retry_after_seconds_non_negative",
    ...
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_class")
            .and_then(Value::as_str),
        Some("bounded_retry")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_class")
            .and_then(Value::as_str),
        Some("bounded_retry")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_class_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_command_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_window_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_signature_key")
            .and_then(Value::as_str),
        Some("class=bounded_retry;after=60;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_signature_key")
            .and_then(Value::as_str),
        Some("class=bounded_retry;after=60;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_signature_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_signature_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/lane_retry_window_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_band_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_mode")
            .and_then(Value::as_str),
        Some("active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_mode")
            .and_then(Value::as_str),
        Some("active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_mode_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_action_vector_key")
            .and_then(Value::as_str),
        Some("bounded_retry|active|dashboard.troubleshooting.recent.state --json")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_action_vector_key")
            .and_then(Value::as_str),
        Some("bounded_retry|active|dashboard.troubleshooting.recent.state --json")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_action_vector_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_points")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_budget_points")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_non_negative")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_budget_from_band")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_band_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_budget_from_expected_band")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_expected_band_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_range_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_pressure_tier")
            .and_then(Value::as_str),
        Some("high")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_pressure_tier")
            .and_then(Value::as_str),
        Some("high")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_pressure_tier_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_pressure_tier_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_key")
            .and_then(Value::as_str),
        Some("points=60;tier=high;mode=active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_budget_vector_key")
            .and_then(Value::as_str),
        Some("points=60;tier=high;mode=active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_window_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_key")
            .and_then(Value::as_str),
        Some("tier=high;after=60;mode=active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_tier_vector_key")
            .and_then(Value::as_str),
        Some("tier=high;after=60;mode=active")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_key")
            .and_then(Value::as_str),
        Some("class=bounded_retry;budget=60;tier=high;after=60;mode=active;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_contract_vector_key")
            .and_then(Value::as_str),
        Some("class=bounded_retry;budget=60;tier=high;after=60;mode=active;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_family_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_severity_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_coherence_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_lane_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_command_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_pressure_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_pressure_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_command_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_mode_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_after_seconds_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_after_seconds_band_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_after_seconds_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_mode_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_command_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_pressure_class_inverse_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_command_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_after_seconds_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_after_seconds_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_command_after_seconds_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_command_after_seconds_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_command_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_mode_pressure_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_command_mode_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_command_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_command_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_mode_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_expected_lane_class_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_after_seconds")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_retry_after_seconds")
            .and_then(Value::as_i64),
        Some(60)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_after_seconds_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/retry_after_seconds_non_negative")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
    ...
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/next_action_command")
            .and_then(Value::as_str),
        Some("dashboard.troubleshooting.recent.state --json")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/expected_next_action_command")
            .and_then(Value::as_str),
        Some("dashboard.troubleshooting.recent.state --json")
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/next_action_command_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/next_action_command_known")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
        payload
            .pointer("/recent/tooling_contract/response_gate/next_action_lane_consistent")
            .and_then(Value::as_bool),
        Some(true)
    );
    assert_eq!(
...
fn dashboard_troubleshooting_response_gate_contract_matrix_ready_degraded_blocked() {
    ...
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_signature_key")
            .and_then(Value::as_str),
        Some("class=none;after=0;lane=none")
    );
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_mode")
    ...
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_key")
            .and_then(Value::as_str),
        Some("points=120;tier=low;mode=passive")
    );
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_known")
    ...
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_key")
            .and_then(Value::as_str),
        Some("tier=low;after=0;mode=passive")
    );
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_known")
    ...
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_key")
            .and_then(Value::as_str),
        Some("class=none;budget=120;tier=low;after=0;mode=passive;lane=none")
    );
    assert_eq!(
        ready_payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_known")
    ...
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_signature_key")
            .and_then(Value::as_str),
        Some("class=single_retry;after=30;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_mode")
    ...
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_action_vector_key")
            .and_then(Value::as_str),
        Some("single_retry|active|dashboard.troubleshooting.recent.state --json")
    );
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_points")
    ...
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_key")
            .and_then(Value::as_str),
        Some("points=90;tier=medium;mode=active")
    );
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_budget_vector_known")
    ...
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_key")
            .and_then(Value::as_str),
        Some("tier=medium;after=30;mode=active")
    );
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_tier_vector_known")
    ...
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_key")
            .and_then(Value::as_str),
        Some("class=single_retry;budget=90;tier=medium;after=30;mode=active;lane=dashboard.troubleshooting.recent.state")
    );
    assert_eq!(
        degraded_payload
            .pointer("/recent/tooling_contract/response_gate/retry_contract_vector_known")
