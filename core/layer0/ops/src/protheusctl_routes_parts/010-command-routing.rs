use super::Route;
// FILE_SIZE_EXCEPTION: reason=Atomic CLI routing block requires semantic extraction to preserve command behavior; owner=jay; expires=2026-04-12
