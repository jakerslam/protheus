...
fn usage() {
    println!("Usage:");
    println!("  infring-ops operator-tooling-kernel status [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel route-model [--payload-base64=<base64_json>] [--policy-path=<path>]");
    println!("  infring-ops operator-tooling-kernel escalate-model [--payload-base64=<base64_json>] [--policy-path=<path>]");
    println!("  infring-ops operator-tooling-kernel plan-auto [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel plan-validate [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel postflight-validate [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel output-validate [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel state-read [--key=<dot.path>] [--state-path=<path>]");
    println!("  infring-ops operator-tooling-kernel state-write [--payload-base64=<base64_json>] [--state-path=<path>]");
    println!("  infring-ops operator-tooling-kernel decision-log-append [--title=<text>] [--reason=<text>] [--verify=<cmd>] [--rollback=<hint>] [--details-base64=<base64_json>] [--decision-log-path=<path>]");
    println!("  infring-ops operator-tooling-kernel safe-apply [--payload-base64=<base64_json>] [--timeout-ms=<n>]");
    println!("  infring-ops operator-tooling-kernel memory-search --query=<text> [--limit=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel memory-summarize --query=<text> [--limit=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel memory-last-change [--limit=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel membrief --query=<text> [--limit=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel trace-find --trace-id=<id> [--limit=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel sync-allowed-models [--control_runtime-root=<path>] [--policy-path=<path>]");
    println!("  infring-ops operator-tooling-kernel smoke-routing [--control_runtime-root=<path>] [--policy-path=<path>]");
    println!("  infring-ops operator-tooling-kernel spawn-safe [--payload-base64=<base64_json>] [--require-plan=1|0] [--strict-plan=1|0]");
    println!("  infring-ops operator-tooling-kernel smart-spawn [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel auto-spawn [--payload-base64=<base64_json>] [--max-attempts=<n>]");
    println!("  infring-ops operator-tooling-kernel execute-handoff [--payload-base64=<base64_json>]");
    println!("  infring-ops operator-tooling-kernel safe-run <domain> [args...] [--timeout-ms=<n>] [--retries=<n>]");
    println!("  infring-ops operator-tooling-kernel control_runtime-health [--since-hours=<n>] [--control_runtime-root=<path>]");
    println!("  infring-ops operator-tooling-kernel cron-drift [--control_runtime-root=<path>] [--workspace-root=<path>]");
    println!("  infring-ops operator-tooling-kernel cron-sync [--control_runtime-root=<path>] [--workspace-root=<path>]");
    println!("  infring-ops operator-tooling-kernel doctor [--control_runtime-root=<path>] [--workspace-root=<path>]");
    println!("  infring-ops operator-tooling-kernel audit-plane [--control_runtime-root=<path>] [--workspace-root=<path>]");
    println!("  infring-ops operator-tooling-kernel daily-brief [--control_runtime-root=<path>] [--workspace-root=<path>]");
    println!("  infring-ops operator-tooling-kernel fail-playbook [--control_runtime-root=<path>] [--workspace-root=<path>]");
}
