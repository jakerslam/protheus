...
fn usage() {
    println!("Usage:");
    println!("  infring-ops runtime-systems <status|verify|run|build|manifest|roi-sweep|entrypoint-context|bootstrap|package|settle> [--system-id=<id>|--lane-id=<id>] [flags]");
}
