...
mod contract_specific_gate_regression_tests {
    ...
    fn expect_strict_error(
        ...
        let err = run_strict_payload(root, id, payload_json).expect_err(failure_message);
        assert!(
            err.contains(expected_error),
            "expected `{expected_error}` violation, got {err}"
        );
        err
    }
    ...
    fn expect_strict_ok(
        ...
        run_strict_payload(root, id, payload_json).expect(success_message)
    }
    ...
    fn v6_dashboard_009_1_requires_message_only_hover_scope() {
        ...
        expect_strict_error(
            ...
            "specific_dashboard_metadata_hover_scope_mismatch",
            "non-message hover scope should fail strict guard",
        );
    }
    ...
    fn v6_dashboard_009_2_requires_server_status_on_startup_failure() {
        ...
        expect_strict_error(
            ...
            "specific_dashboard_server_status_missing_on_failure",
            "startup failure without status artifact should fail strict guard",
        );
    }
    ...
    fn v6_infring_gap_001_4_requires_security_parity_controls() {
        ...
        expect_strict_error(
            ...
            "missing taint tracking should fail strict guard",
        );
    }
    ...
    fn v6_infring_gap_001_2_passes_with_explicit_valid_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "explicit valid http/ws payload should pass",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_3_passes_with_explicit_valid_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "explicit valid channel adapter payload should pass",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_4_passes_with_explicit_valid_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "explicit valid security parity payload should pass",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_5_passes_with_explicit_valid_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "explicit valid hands parity payload should pass",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_2_passes_with_default_contract_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "V6-INFRING-GAP-001.2",
            None,
            "http/ws parity contract should pass with defaults",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_1_passes_with_default_contract_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "V6-INFRING-GAP-001.1",
            None,
            "llm runtime parity contract should pass with defaults",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_3_passes_with_default_contract_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "V6-INFRING-GAP-001.3",
            None,
            "channel adapter parity contract should pass with defaults",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_4_passes_with_default_contract_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "V6-INFRING-GAP-001.4",
            None,
            "security parity contract should pass with defaults",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
    ...
    fn v6_infring_gap_001_5_passes_with_default_contract_payload() {
        ...
        let out = expect_strict_ok(
            ...
            "V6-INFRING-GAP-001.5",
            None,
            "hands/skills parity contract should pass with defaults",
        );
        assert_eq!(out.get("ok").and_then(Value::as_bool), Some(true));
    }
}
