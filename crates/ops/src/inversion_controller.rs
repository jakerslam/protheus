...
pub const LEGACY_SCRIPT_REL: &str = "systems/autonomy/inversion_controller_legacy.js";
...
"#,
        ...
        assert!(stdout.contains("run --objective=test --impact=high --target=tactical"));
    }
