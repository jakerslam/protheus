...
const DEFAULT_POLICY_REL: &str = "config/f100_reliability_certification_policy.json";
...
mod tests {
    ...
    fn write_policy(root: &Path, strict_default: bool) {
        ...
        write_json(&root.join("config/f100_reliability_certification_policy.json"), &policy);
    }
