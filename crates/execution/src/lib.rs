...
pub use autoscale::{
    ...
    compute_policy_hold_pressure, compute_receipt_verdict, compute_token_usage, run_autoscale_json,
    BatchMaxInput, BatchMaxOutput, CriteriaGateInput, CriteriaGateOutput, DynamicCapsInput,
    DynamicCapsOutput, NormalizeQueueInput, NormalizeQueueOutput, PlanInput, PlanOutput,
    PolicyHoldCooldownInput, PolicyHoldCooldownOutput, PolicyHoldInput, PolicyHoldOutput,
