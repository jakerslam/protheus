...
pub use decompose::{
    ...
    evaluate_route_decision, evaluate_route_decision_json, evaluate_route_habit_readiness,
    evaluate_route_habit_readiness_json,
    evaluate_route_complexity, evaluate_route_complexity_json, evaluate_route_match,
    evaluate_route_match_json, evaluate_route_primitives, evaluate_route_primitives_json,
    evaluate_route_reflex_match, evaluate_route_reflex_match_json, evaluate_route,
    evaluate_route_json, evaluate_heroic_gate, evaluate_heroic_gate_json, queue_rows_json,
    summarize_dispatch,
    summarize_dispatch_json, summarize_tasks, summarize_tasks_json, BaseTask, Capability,
    ComposePolicy, ComposeRequest, ComposeResponse, DecomposePolicy, DecomposeRequest,
    ...
    RouteDecisionRequest, RouteDecisionResponse, RouteEvaluateRequest, RouteEvaluateResponse,
    RouteHabitReadinessRequest, RouteHabitReadinessResponse, RouteMatchRequest, RouteMatchResponse,
