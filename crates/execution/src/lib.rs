...
pub use autoscale::{
    ...
    compute_policy_hold_pattern, compute_policy_hold_pressure, compute_policy_hold_result,
    compute_receipt_verdict, compute_route_execution_policy_hold, compute_safety_stop_run_event,
    compute_token_usage, run_autoscale_json, AttemptRunEventInput, AttemptRunEventOutput,
    BatchMaxInput, BatchMaxOutput, CriteriaGateInput, CriteriaGateOutput, DynamicCapsInput,
    DynamicCapsOutput, NoProgressResultInput, NoProgressResultOutput, NonYieldCategoryInput,
    NonYieldCategoryOutput, NormalizeQueueInput, NormalizeQueueOutput, PlanInput, PlanOutput,
