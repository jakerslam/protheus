...
PROOF_FILE="$ROOT/proofs/layer1/Layer1Invariants.lean"
...
ARTIFACT_PATH="$ROOT/core/local/artifacts/layer1_invariant_proof_pack.json"
...
payload = {
    "ok": True,
    "type": "layer1_invariant_proof_pack",
    ...
    "invariants": [
        ...
        "deterministic_canonical_routing",
        "receipt_presence_and_freshness",
    ],
}
