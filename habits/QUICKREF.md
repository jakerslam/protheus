...
# 2. VERIFY
 node habits/scripts/run_habit.js --id NEW --json '{}'
 node habits/scripts/doctor.js  # must pass
...
{
  "network": "deny",
  "write_paths_allowlist": ["memory/*.md", "habits/logs/*"],
...
node habits/scripts/propose_habit.js --from "desc" --repeats_14d 4 --tokens_est 600

# Propose (Trigger B: tokens>=2000)
node habits/scripts/propose_habit.js --from "desc" --tokens_est 2500

# Propose (Trigger C: errors>=2)
node habits/scripts/propose_habit.js --from "desc" --errors_30d 3

# List
node habits/scripts/run_habit.js --list

# Run
node habits/scripts/run_habit.js --id HABIT_ID --json '{}'
