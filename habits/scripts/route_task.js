#!/usr/bin/env node
/**
 * route_task.js v1.1 - Directive Gate Integration
 * Decide: MANUAL vs RUN_HABIT vs PROPOSE_HABIT with T0/T1 tiered directive enforcement
 *
 * v1.1: Added directive gate evaluation before run decisions
 *
 * Inputs:
...
const { evaluateTask, logGateDecision } = require('./directive_gate.js');
