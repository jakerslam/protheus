...
const TRUSTED_SKILLS_PATH = '/Users/jay/.openclaw/workspace/config/trusted_skills.json';
...
function checkClearTriggers() {
  ...
  for (const habit of registry.habits) {
    ...
    const hasEntrypoint = typeof habit.entrypoint === 'string' && 
                          habit.entrypoint.startsWith('habits/routines/');
...
function checkNetworkDeny() {
  ...
  const testCases = [
    ...
    ['node memory/tools/rebuild_exclusive.js', false]
  ];
...
function checkCronDependencies() {
  ...
  const CRON_JOBS_PATH = '/Users/jay/.openclaw/workspace/config/cron_jobs.json';
...
function checkDocDrift() {
  ...
  let proposeSrc;
  try {
    proposeSrc = fs.readFileSync('/Users/jay/.openclaw/workspace/habits/scripts/propose_habit.js', 'utf8');
  } catch (e) {
  ...
  const QUICKREF_PATH = '/Users/jay/.openclaw/workspace/habits/QUICKREF.md';
  const GOV_PATH = '/Users/jay/.openclaw/workspace/habits/GOVERNANCE.md';
