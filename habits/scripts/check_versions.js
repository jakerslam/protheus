 ...
 * 
 * Usage: node habits/scripts/check_versions.js
 *        node habits/scripts/check_versions.js --check <layer>
 */
...
function printAllVersions() {
  ...
  console.log('═══════════════════════════════════════');
  console.log('To update a layer: edit file, then update config/layer_versions.json');
}
