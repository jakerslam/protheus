...
function main() {
  ...
  console.log('');
  console.log('USAGE:');
  console.log('  node habits/scripts/run_habit.js --list');
  console.log('  node habits/scripts/run_habit.js --id <habit_id> --json \'{}\'');
  console.log('  node habits/scripts/habit_list.js --trusted');
  console.log('');
}
