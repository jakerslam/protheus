...
function usage() {
  console.log('Usage:');
  console.log('  node habits/scripts/install_skill_safe.js --spec "<source>" [--approve=1 --approval_note "..."] [--autonomous=1 --justification-file <file>|--justification-json "<json>"] [--dry-run]');
  console.log('');
  ...
  console.log('  node habits/scripts/install_skill_safe.js --spec "github:org/repo/skill" --autonomous=1 --justification-file "./state/autonomy/skill_justification.json" --dry-run');
}
