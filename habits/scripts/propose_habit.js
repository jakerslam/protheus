...
const HABITS_LOG = '/Users/jay/.openclaw/workspace/habits/logs/habit_runs.ndjson';
...
function main() {
  ...
  const proposal = {
    ...
    entrypoint: `habits/routines/${slug}.js`,
  ...
  console.log(`  1. Create: habits/routines/${slug}.js`);
  console.log(`  2. Trust: node habits/scripts/trust_add_habit.js habits/routines/${slug}.js "${description.substring(0, 50)}"`);
