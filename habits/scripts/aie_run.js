 ...
 * 
 * Usage:
 *   node habits/scripts/aie_run.js --repo=/path/to/repo -- command arg1 arg2
 * 
 * Example:
 *   node habits/scripts/aie_run.js --repo=~/.openclaw/workspace -- node memory/tools/tests/aie.test.js
 * 
...
function main() {
  ...
  if (cmdStart === -1 || cmdStart >= args.length) {
    console.error('Usage: node habits/scripts/aie_run.js --repo=/path/to/repo -- command arg1 arg2');
    process.exit(1);
  }
