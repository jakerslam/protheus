...
const SYSTEM_ID = 'SYSTEMS-SENSORY-VALUE_OF_INFORMATION_COLLECTION_PLANNER';
const bridge = createOpsLaneBridge(__dirname, 'value_of_information_collection_planner', 'runtime-systems', {
  inheritStdio: true
});
