...
const SYSTEM_ID = 'SYSTEMS-ROUTING-LLM_GATEWAY_FAILURE_CLASSIFIER';
const bridge = createOpsLaneBridge(__dirname, 'llm_gateway_failure_classifier', 'runtime-systems', {
  inheritStdio: true
});
