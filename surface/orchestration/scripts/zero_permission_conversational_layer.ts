...
const SYSTEM_ID = 'SYSTEMS-AUTONOMY-ZERO_PERMISSION_CONVERSATIONAL_LAYER';
const bridge = createOpsLaneBridge(__dirname, 'zero_permission_conversational_layer', 'runtime-systems', {
  inheritStdio: true
});
