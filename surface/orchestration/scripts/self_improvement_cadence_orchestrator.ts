...
const SYSTEM_ID = 'SYSTEMS-AUTONOMY-SELF_IMPROVEMENT_CADENCE_ORCHESTRATOR';
const bridge = createOpsLaneBridge(__dirname, 'self_improvement_cadence_orchestrator', 'runtime-systems', {
  inheritStdio: true
});
