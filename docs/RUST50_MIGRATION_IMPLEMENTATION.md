...
- Program: `systems/ops/rust50_migration_program.ts`
- Policy: `config/rust50_migration_program_policy.json`
- Mobile adapter: `systems/hybrid/mobile/protheus_mobile_adapter.ts`
- Rust core: `systems/hybrid/rust/src/*.rs`

## Commands

```bash
node systems/ops/rust50_migration_program.js list
node systems/ops/rust50_migration_program.js run-all --apply=1 --strict=0
node systems/ops/rust50_migration_program.js run --id=V6-RUST50-007 --apply=1 --strict=1
node systems/ops/rust50_migration_program.js status
```
