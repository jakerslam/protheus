...
`client/runtime/systems/memory/memory_fallback_retirement_gate.ts` governs whether `memory_recall` may fall back from Rust to JS.

## Policy

Policy file: `client/runtime/config/memory_fallback_retirement_policy.json`
