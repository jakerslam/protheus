...
`client/runtime/systems/continuity/resurrection_protocol.ts` provides catastrophic recovery ceremonies for rehydrating continuity-critical state onto a new host.
...
Policy file: `client/runtime/config/resurrection_protocol_policy.json`
