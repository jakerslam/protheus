...
| `client/runtime/lib/legacy_retired_lane_bridge.js` | Legacy conduit fallback shim | `client/runtime/lib/spine_conduit_bridge.ts` and domain bridges | no production path imports legacy bridge |
