...
- `/orchestration/`: Rust-first orchestration control-plane coordination contracts; orchestration tracked source should remain at least `95%` Rust, with TS/TSX wrappers allowed only for thin ingress/packaging interfaces.
