...
- `client/runtime/systems/identity/identity_organ.ts`
- `client/runtime/systems/identity/identity_integrity_oracle.ts`
- `client/runtime/systems/identity/visual_signature_engine.ts` (`V3-RACE-134`)
- `client/runtime/systems/contracts/soul_contracts.ts` (`V3-RACE-129`)
