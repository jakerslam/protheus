...
`client/runtime/systems/primitives/effect_type_system.ts` enforces plan-time effect governance for workflow execution.
...
Policy file: `client/runtime/config/effect_type_policy.json`
...
`client/runtime/systems/workflow/workflow_executor.ts` evaluates effect plans before any step execution.
