...
- Rust core crate: `client/runtime/systems/hybrid/rust`
- Ops executor: `client/runtime/systems/ops/rust_hybrid_migration_program.ts`
- Policy: `client/runtime/config/rust_hybrid_migration_program_policy.json`
...
- Fail-closed lane receipts on missing docs/client/policy contracts.
