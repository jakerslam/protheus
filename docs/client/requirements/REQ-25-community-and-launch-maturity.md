...
- Acceptance:
  - `docs/client/community/GOOD_FIRST_ISSUES.md` exists with 10 scoped issues.
...
- Acceptance:
  - `docs/client/announcements/INFRING_LAUNCH_TEMPLATE.md` exists with ready-to-post templates.
...
- Acceptance:
  - Human-governed publication of release tags/announcements is tracked in `docs/client/HUMAN_ONLY_ACTIONS.md`.
