...
- Migrated remaining legacy `client/runtime/systems/primitives/*` wrapper lanes to direct conduit (`canonical_event_log`, `cognitive_control_primitive`, `policy_vm`, `primitive_catalog`, `primitive_registry`, `replay_verify`).
