...
Acceptance: `client/memory/tools/rebuild_exclusive.js` is part of the recurring operational schedule and produces refreshed index artifacts without archive leakage.
