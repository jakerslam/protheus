...
`client/runtime/systems/hardware/embodiment_layer.ts` provides a unified capability + surface-budget contract so core runtime lanes can stay hardware-neutral.
...
Policy file: `client/runtime/config/embodiment_layer_policy.json`
