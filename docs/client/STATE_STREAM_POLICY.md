...
|---|---|---|---|
| `source_of_truth` | tracked | `client/runtime/systems/**`, `client/lib/**`, `client/runtime/config/**`, `docs/client/**`, `client/memory/tools/**` | Canonical implementation, policies, and operator docs stay reviewable in git history. |
