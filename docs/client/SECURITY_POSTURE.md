...
Source: `validation/release_gates/contracts/guard_check_registry.json` (`merge_guard.checks`)

Evidence-linked inventory:
- `docs/client/security/SECURITY_LAYER_INVENTORY.md` (generated by `node client/runtime/systems/ops/security_layer_inventory_gate.ts run --strict=1 --write=1`)
