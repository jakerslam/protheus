...
`client/runtime/systems/ops/backlog_registry.ts` is the canonical backlog governance lane.

## Source Of Truth

- Authoritative human source: `docs/workspace/SRS.md` (`docs/workspace/UPGRADE_BACKLOG.md` compatibility alias retained)
- Generated artifacts:
...
- `client/runtime/systems/ops/backlog_queue_executor.ts` is a receipt/materialization lane.
...
- `client/runtime/systems/ops/backlog_lane_batch_delivery.ts` provides lane execution coverage for IDs that lacked dedicated lane scripts.
- Policy: `client/runtime/config/backlog_lane_batch_delivery_policy.json`
