...
`client/runtime/systems/memory/causal_temporal_graph.ts` builds a policy-gated causal graph over canonical runtime events.
...
Policy file: `client/runtime/config/causal_temporal_memory_policy.json`
