...
| `helm_packaging_present` | `file_exists` | `client/runtime/deploy/helm/infring/Chart.yaml` | PASS | `ok` |
| `helm_conformance_ci_present` | `file_exists` | `.github/workflows/helm-conformance.yml` | PASS | `ok` |
| `helm_sso_values_present` | `file_contains` | `client/runtime/deploy/helm/infring/values.yaml` | PASS | `ok` |
| `helm_vault_values_present` | `file_contains` | `client/runtime/deploy/helm/infring/values.yaml` | PASS | `ok` |
| `helm_nvidia_values_present` | `file_contains` | `client/runtime/deploy/helm/infring/values.yaml` | PASS | `ok` |
| `helm_daemon_multinode_present` | `file_exists` | `client/runtime/deploy/helm/infring/templates/deployment.yaml` | PASS | `ok` |
| `helm_conformance_test_hook_present` | `file_exists` | `client/runtime/deploy/helm/infring/templates/tests/conformance.yaml` | PASS | `ok` |
| `terraform_packaging_present` | `file_exists` | `client/runtime/deploy/terraform/infring_helm/main.tf` | PASS | `ok` |
| `terraform_enterprise_inputs_present` | `file_contains` | `client/runtime/deploy/terraform/infring_helm/variables.tf` | PASS | `ok` |
