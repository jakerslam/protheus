...
- Area: `area/conduit`
- Acceptance:
  - Add `docs/client/conduit/message_examples/*.json` samples for command/event types.
...
- Area: `area/docs`
- Acceptance:
  - Add “Common Failures” section to `docs/client/GETTING_STARTED.md`.
...
- Area: `area/community`
- Acceptance:
  - Add simple markdown lint/consistency check for `docs/client/announcements/`.
