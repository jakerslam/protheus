...
`client/runtime/systems/echo/value_anchor_renewal.ts` recalibrates long-horizon value anchors from constitution + first-principles evidence and emits reversible, auditable updates.
...
Policy file: `client/runtime/config/value_anchor_renewal_policy.json`
