...
Date: 2026-03-06
Scope: `client/runtime/systems/primitives/*.ts` + `primitive_ts_wrapper_contract` entries

## client/runtime/systems/primitives Summary
...
- client/runtime/systems/primitives/action_grammar.ts (non_wrapper_ts_logic; source=client/runtime/systems/primitives)
