...
Date: 2026-02-26  
Scope: `client/runtime/systems/workflow/workflow_executor.ts`
...
- Runner enforces workflow-level caps from `client/runtime/config/workflow_executor_policy.json`:
...
- `client/memory/tools/tests/workflow_executor.test.js`
- `client/memory/tools/tests/workflow_executor_rollback_hardening.test.js`
