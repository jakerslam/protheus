...
`systems/primitives/explanation_primitive.ts` implements `V3-058`.
...
- `node systems/primitives/explanation_primitive.js explain --event-id=<id|latest> --category=<major_decision|policy_denial|self_modification> --summary="..." [--narrative="..."] [--decision=<allow|deny|propose>] [--objective-id=<id>] [--apply=1|0]`
- `node systems/primitives/explanation_primitive.js verify --explanation-id=<id> [--strict=1|0]`
- `node systems/primitives/explanation_primitive.js status`
...
`config/explanation_primitive_policy.json` controls:
