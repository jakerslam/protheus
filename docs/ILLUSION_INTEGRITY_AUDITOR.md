...
- Manual:
  - `node systems/self_audit/illusion_integrity_lane.js run --trigger=manual`
...
- Rust scanner core:
  - `systems/self_audit/illusion_integrity_auditor.rs`
  - `systems/self_audit/rust/Cargo.toml`
- TS orchestration lane:
  - `systems/self_audit/illusion_integrity_lane.ts`
...
- Required artifact presence (README/changelog/docs/templates)
- Backlog drift (`systems/ops/backlog_registry.js check`)
...
- Reports: `state/self_audit/illusion_integrity/reports/`
- Patch suggestions: `state/self_audit/illusion_integrity/patches/`
