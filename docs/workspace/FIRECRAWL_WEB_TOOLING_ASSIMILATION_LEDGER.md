...
| `/Users/jay/.openclaw/workspace/local/workspace/shadow/external-repos/firecrawl/apps/api/src/__tests__/snips/v2/scrape.test.ts` | partial | scrape runtime contracts | Extracted waitFor budget validation, invalid URL errors, non-UTF-8 handling, links/images output, local-network blocking, action gating, JSON raw fetch, and cache identity sensitivity to formats/headers/mobile. Remaining production/browser/cache subcases pending. |
| `/Users/jay/.openclaw/workspace/local/workspace/shadow/external-repos/firecrawl/apps/api/src/__tests__/snips/v2/types-validation.test.ts` | partial | request-shape schema discipline | Extracted default markdown format, string-to-object format preprocessing, query/question/highlights validation, waitFor<=timeout/2, parser bounds, proxy timeout transforms, location validation, bounded actions, lockdown defaults, extraction URL limits, and crawl defaults. Remaining schema sections pending. |
...
| `/Users/jay/.openclaw/workspace/local/workspace/shadow/external-repos/firecrawl/apps/api/src/__tests__/snips/v2/billing.test.ts` | partial | cost accounting by operation/result count | Extracted per-operation billing shapes for scrape, parse, batch, crawl, map, and search result counts. Pattern maps to explicit retrieval budgets and receipts. Remaining historical usage cases pending. |
...
| Tests and evals | Remaining v2 partial sections, v1/e2e tests, scrape load/eval artifacts | medium | Core v2 test files are parsed or partially parsed. Remaining work is long-file tail coverage and older/e2e parity, not an obvious blocker for current web research quality. |
