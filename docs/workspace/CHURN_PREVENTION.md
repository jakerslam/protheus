...
- `.githooks/pre-commit` runs `npm run -s ops:srs:full:regression` when staged changes touch `docs/workspace/SRS.md`, `docs/workspace/todo/TODO.md`, `docs/workspace/UPGRADE_BACKLOG.md`, or `core/layer0/ops/tests/v8_runtime_proof.rs`.
