...
- [x] `TU-024` Sweep secondary docs to remove inconsistent old/new terminology mixing (`planes`, `adapters`, `client/shell`). (2026-04-22: canonical-first terminology sweep applied to `docs/client/architecture/LAYER_RULEBOOK.md`, `docs/workspace/process/roadmap_adapter_graduation_plan.md`, `docs/workspace/client_naming_policy.md`, and `README.md` with explicit compatibility-alias context retained.)
