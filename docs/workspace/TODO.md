...
- [ ] `V11-ORCH-007` — in_progress — Orchestration Probe-Authority and Runtime-Quality Densification Intake (2026-04-15, planner/runtime consistency + sample-floor + ratchet + rate-domain/count-coherence increment + all-candidates subset-of-zero-executable coherence increment)
- [ ] `V11-TOOL-006` — in_progress — Tooling and Task-Fabric Integrity Intake (2026-04-10, run_protheus_ops production process-fallback hard-lock increment + bridge-path release-guard explicit env-zero contract increment)
