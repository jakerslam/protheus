...
1. Authority change exists in the correct layer (core for canonical truth; `surface/orchestration/**` for non-canonical control-plane coordination such as decomposition/coordination/sequencing/recovery/packaging; client only thin UX/wrapper).
