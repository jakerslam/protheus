...
```bash
node systems/security/ip_posture_review.js draft --apply=1
node systems/security/ip_posture_review.js evidence-pack --apply=1
node systems/security/ip_posture_review.js record-counsel --counsel="outside_counsel" --decision=approve --approval-note="initial review" --apply=1
node systems/security/ip_posture_review.js status --strict=1
```
