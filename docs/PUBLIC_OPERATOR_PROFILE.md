...
- `docs/OPERATOR_RUNBOOK.md` for incident/operations procedures
- `CONTRIBUTING.md`, `SECURITY.md`, and `LICENSE` for contribution and policy posture

## Internal Artifact Handling

Persona- and memory-heavy root artifacts are treated as internal compatibility surfaces and mirrored under `docs/internal/persona/`.
