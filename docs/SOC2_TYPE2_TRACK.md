...
```bash
node systems/ops/soc2_type2_track.js run --days=90 --strict=1
node systems/ops/soc2_type2_track.js exception-open --id=exc_cc6 --control=cc6 --reason="control evidence gap"
node systems/ops/soc2_type2_track.js exception-close --id=exc_cc6 --resolution="evidence attached"
node systems/ops/soc2_type2_track.js bundle --window-id=latest
node systems/ops/soc2_type2_track.js status
```

## Policy

Policy file: `config/soc2_type2_policy.json`
