...
```bash
node systems/ops/type_derived_lane_docs_autogen.js generate --apply=1 --strict=1
node systems/ops/type_derived_lane_docs_autogen.js verify --strict=1
node systems/ops/type_derived_lane_docs_autogen.js rollback --apply=1
```
