...
```bash
node systems/ops/rust_authoritative_microkernel_acceleration.js run --strict=1 --apply=1
node systems/ops/rust_authoritative_microkernel_acceleration.js report
node systems/ops/rust_authoritative_microkernel_acceleration.js status
```
