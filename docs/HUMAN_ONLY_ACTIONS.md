...
| HMAN-016 | Approve seed-swarm inheritance and revocation policy | Requires legal/operational accountability for parent-child governance boundaries | `state/ops/evidence/rsi_spawn_inheritance_policy_<date>.md` | `V3-RACE-182`, `V3-RACE-131` |
