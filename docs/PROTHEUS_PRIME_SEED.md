...
`systems/ops/protheus_prime_seed.js` is the conformance and packaging entrypoint for the Prime seed profile.

## Commands

```bash
# Show normalized profile contract
node systems/ops/protheus_prime_seed.js manifest

# Verify bootstrap conformance and provision minimal core files
node systems/ops/protheus_prime_seed.js bootstrap

# Build reproducible package metadata (strict fail-closed)
node systems/ops/protheus_prime_seed.js package --strict=1
```
