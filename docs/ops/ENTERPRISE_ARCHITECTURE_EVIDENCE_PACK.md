...
- Rust TCB: `crates/*`
- Conduit bridge: `crates/conduit`
- TS surfaces: `systems/ui`, `systems/marketplace`, `systems/extensions`
...
## Rollback Narratives
- Last-known-good rollback contract is encoded in `config/release_rollback_policy.json`.
- Canary rollback enforcement remains active in release gate policies.

## Evidence Links
- [Reliability Policy](../../config/f100_reliability_certification_policy.json)
- [Supply Chain Policy](../../config/supply_chain_provenance_v2_policy.json)
