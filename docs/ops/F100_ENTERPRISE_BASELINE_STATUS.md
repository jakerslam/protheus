...
| `security_posture_doc` | `file_exists` | `docs/SECURITY_POSTURE.md` | PASS | `ok` |
...
| `helm_packaging_present` | `file_exists` | `deploy/helm/protheus/Chart.yaml` | PASS | `ok` |
| `terraform_packaging_present` | `file_exists` | `deploy/terraform/protheus_helm/main.tf` | PASS | `ok` |
| `human_split_compliance_certs` | `file_contains` | `docs/HUMAN_ONLY_ACTIONS.md` | PASS | `ok` |
