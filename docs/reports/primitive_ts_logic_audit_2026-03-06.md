...
Date: 2026-03-06
Scope: `systems/primitives/*.ts` + `primitive_ts_wrapper_contract` entries

## systems/primitives Summary
...
- systems/primitives/action_grammar.ts (non_wrapper_ts_logic; source=systems/primitives)
