...
fn runtime_execution_observation_channel_projects_into_execution_state() {
    ...
    runtime.apply_execution_observation_update(
        infring_orchestration_v1::contracts::OrchestrationExecutionObservationUpdate {
            session_id: "observation-channel".to_string(),
            observation: infring_orchestration_v1::contracts::CoreExecutionObservation {
                plan_status: Some(infring_orchestration_v1::contracts::PlanStatus::Running),
                ...
                step_statuses: vec![
                    infring_orchestration_v1::contracts::CoreExecutionStepObservation {
                        ...
                        status: infring_orchestration_v1::contracts::StepStatus::Running,
                    },
                ],
            },
        },
    ...
    assert_eq!(
        ...
        infring_orchestration_v1::contracts::PlanStatus::Running
    );
    assert_eq!(
        package
            .execution_state
...
fn workflow_phase_trace_projects_orchestration_lifecycle_for_eval_consumers() {
    ...
    assert_eq!(
        trace.trace_type,
        infring_orchestration_v1::telemetry::WORKFLOW_PHASE_TRACE_TYPE
    );
...
fn repeated_self_maintenance_projection_collapses_into_observe_only_window() {
    ...
    assert!(
        ...
        "rate-limited repeats should not emit another review fallback"
    );
...
fn failed_execution_observation_triggers_feedback_reroute_contract() {
    ...
    runtime.record_execution_observation(
        ...
        infring_orchestration_v1::contracts::CoreExecutionObservation {
            plan_status: Some(infring_orchestration_v1::contracts::PlanStatus::Failed),
...
fn failed_execution_without_viable_alternative_emits_terminal_feedback_contract() {
    ...
    assert!(package
        ...
        .is_some_and(|row| !matches!(
            row.decision,
            infring_orchestration_v1::contracts::RecoveryDecision::None
        )));
}
