use super::*;
use infring_orchestration_v1::planner::preconditions::deterministic_routing_decision_trace;
...
fn adapted_probe_authority_matrix_executes_50_real_cases() {
    ...
    for surface in strict_surfaces {
        for case in &matrix {
            ...
            let probe = infring_orchestration_v1::planner::preconditions::probe_capability(
                &request,
                &case.capability,
            );
