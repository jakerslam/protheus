...
const DEFAULT_FIX_BEFORE_PATH: &str = "validation/evals/fixtures/eval_fix_verification_before.json";
const DEFAULT_FIX_AFTER_PATH: &str = "validation/evals/fixtures/eval_fix_verification_after.json";
