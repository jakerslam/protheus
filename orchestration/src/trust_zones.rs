...
pub const DEFAULT_TRUST_ZONES_PATH: &str = "orchestration/config/trust_zones.json";
...
fn build_guard_report(
    ...
    let control_plane_denied = evaluations
        .iter()
        .any(|row| row.target_path.starts_with("orchestration/") && !row.apply_allowed);
    ...
    let checks = vec![
        ...
        CheckRow {
            ...
            detail: "orchestration/** is propose-only for self-modification".to_string(),
        },
        CheckRow {
...
fn default_probe_targets() -> Vec<String> {
    vec![
        ...
        "orchestration/config/self_modification_policy.json".to_string(),
        "orchestration/src/self_modification.rs".to_string(),
        ...
        TrustZonePolicy {
            ...
            zones: vec![
                ...
                TrustZoneRule {
                    ...
                    path_prefixes: vec!["orchestration/".to_string()],
                    apply_allowed: false,
                    propose_allowed: true,
                },
                TrustZoneRule {
