...
const DEFAULT_POLICY_PATH: &str = "validation/evals/fixtures/eval_rsi_promotion_ladder.json";
const DEFAULT_REDTEAM_PATH: &str = "validation/evals/fixtures/eval_holdout_red_team_cases.json";
