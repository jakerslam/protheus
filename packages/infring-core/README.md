...
```bash
node client/runtime/lib/ts_entrypoint.ts packages/infring-core/starter.ts
```

Optional flags:

```bash
node client/runtime/lib/ts_entrypoint.ts packages/infring-core/starter.ts --spine=1 --reflex=0 --gates=1
```
