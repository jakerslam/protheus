...
function resolveAutopausePath(opts = {}) {
...
function loadSystemBudgetAutopauseState(opts = {}) {
...
function saveSystemBudgetAutopauseState(state, opts = {}) {
  const fp = resolveAutopausePath(opts);
...
function setSystemBudgetAutopause(input = {}, opts = {}) {
...
function clearSystemBudgetAutopause(input = {}, opts = {}) {
  const current = loadSystemBudgetAutopauseState(opts);
  const next = saveSystemBudgetAutopauseState({
    ...current,
    active: false,
