...
/**
 * Runtime lane for SYSTEMS-PRIMITIVES-LONG-HORIZON-PLANNING-PRIMITIVE.
...
const lane = createConduitLaneModule('SYSTEMS-PRIMITIVES-LONG-HORIZON-PLANNING-PRIMITIVE', ROOT);
