...
/**
 * Runtime lane for SYSTEMS-ATTRIBUTION-VALUE-ATTRIBUTION-PRIMITIVE.
...
const lane = createConduitLaneModule('SYSTEMS-ATTRIBUTION-VALUE-ATTRIBUTION-PRIMITIVE', ROOT);
