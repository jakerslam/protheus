...
/**
 * Runtime lane for SYSTEMS-SENSORY-DETECTOR-ROLLBACK-MIGRATION-SAFETY-CONTRACT.
...
const lane = createLaneModule('SYSTEMS-SENSORY-DETECTOR-ROLLBACK-MIGRATION-SAFETY-CONTRACT', ROOT);
