...
/**
 * Runtime lane for SYSTEMS-ASSIMILATION-CONTEXT-NAVIGATION-PRIMITIVE.
...
const lane = createConduitLaneModule('SYSTEMS-ASSIMILATION-CONTEXT-NAVIGATION-PRIMITIVE', ROOT);
