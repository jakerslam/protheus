...
/**
 * Runtime lane for SYSTEMS-ASSIMILATION-CAPABILITY-PROFILE-COMPILER.
...
const lane = createConduitLaneModule('SYSTEMS-ASSIMILATION-CAPABILITY-PROFILE-COMPILER', ROOT);
