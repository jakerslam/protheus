...
function readRunsInWindow(endDate: string, days = 14) {
  const rows: AnyObj[] = [];
...
function evidenceLinks(endDate: string) {
...
function existingOpenAlignmentEscalation(signature: string) {
...
function maybeEmitEscalation(payload: AnyObj, allowEscalate = true) {
