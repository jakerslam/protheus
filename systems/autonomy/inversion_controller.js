...
/**
 * Rust cutover wrapper for inversion_controller.
 *
 * - Preserves CLI path (`node systems/autonomy/inversion_controller.js ...`)
...
const legacy = require('./inversion_controller_legacy.js');
function runRustCli() {
