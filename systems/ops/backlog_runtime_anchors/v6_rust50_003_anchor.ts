...
/**
 * Runtime anchor for V6-RUST50-003
...
const LANE_ID = 'V6-RUST50-003';
const TITLE = "Pinnacle CRDT Rust Engine Phone-First";
const WAVE = "V6";
...
const REQUIRED_REFS = [
  ...
  "state/ops/rust50_migration_program/artifacts/v6_rust50_003_crdt_core.json"
];
