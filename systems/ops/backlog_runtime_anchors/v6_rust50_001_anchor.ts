...
/**
 * Runtime anchor for V6-RUST50-001
...
const LANE_ID = 'V6-RUST50-001';
const TITLE = "Memory 100 Percent Rust Core + WASM Mobile Bindings";
const WAVE = "V6";
...
const REQUIRED_REFS = [
  ...
  "state/ops/rust50_migration_program/artifacts/v6_rust50_001_memory_core.json"
];
