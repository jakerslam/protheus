...
/**
 * Runtime anchor for V6-RUST50-002
...
const LANE_ID = 'V6-RUST50-002';
const TITLE = "Execution Deterministic Runtime Rust Cutover + Replay Proofs";
const WAVE = "V6";
const CLASS = "primitive-upgrade";
const DEPENDENCIES = [
  "V5-RUST-HYB-003",
  "V5-RUST-PROD-003",
  "V5-RUST-PROD-008"
...
const REQUIRED_REFS = [
  ...
  "state/ops/rust50_migration_program/artifacts/v6_rust50_002_execution_core.json"
];
