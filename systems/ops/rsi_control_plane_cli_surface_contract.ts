...
/**
 * Runtime lane for SYSTEMS-OPS-RSI-CONTROL-PLANE-CLI-SURFACE-CONTRACT.
...
const lane = createLaneModule('SYSTEMS-OPS-RSI-CONTROL-PLANE-CLI-SURFACE-CONTRACT', ROOT);
