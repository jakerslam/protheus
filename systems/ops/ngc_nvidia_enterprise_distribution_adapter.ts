...
/**
 * Runtime lane for SYSTEMS-OPS-NGC-NVIDIA-ENTERPRISE-DISTRIBUTION-ADAPTER.
...
const lane = createLaneModule('SYSTEMS-OPS-NGC-NVIDIA-ENTERPRISE-DISTRIBUTION-ADAPTER', ROOT);
