...
/**
 * Runtime lane for SYSTEMS-OPS-CHROMEOS-FUCHSIA-DISTRIBUTION-OTA-ADAPTER.
...
const lane = createLaneModule('SYSTEMS-OPS-CHROMEOS-FUCHSIA-DISTRIBUTION-OTA-ADAPTER', ROOT);
