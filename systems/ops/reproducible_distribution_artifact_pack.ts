...
/**
 * Runtime lane for SYSTEMS-OPS-REPRODUCIBLE-DISTRIBUTION-ARTIFACT-PACK.
...
const lane = createLaneModule('SYSTEMS-OPS-REPRODUCIBLE-DISTRIBUTION-ARTIFACT-PACK', ROOT);
