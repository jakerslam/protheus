...
node systems/economy/public_donation_api.js donate --donor_id=alice --gpu_hours=24 --proof_ref=tx123
node systems/economy/public_donation_api.js status --donor_id=alice
node systems/economy/tithe_engine.js status --donor_id=alice
