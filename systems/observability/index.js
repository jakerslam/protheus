...
function loadEmbeddedObservabilityProfile(opts = {}) {
...
function runChaosObservability(request, opts = {}) {
    ...
    if (binResult.ok) {
        return {
            ...binResult,
            payload: normalizeChaosPayloadLegacyCompat(binResult.payload)
        };
    }
    if (!allowCliFallback)
        return binResult;
    ...
    return {
        ...cargoResult,
        payload: normalizeChaosPayloadLegacyCompat(cargoResult.payload)
    };
}
module.exports = {
