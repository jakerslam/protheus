...
/**
 * Rust cutover wrapper for workflow executor.
 *
 * - Preserves CLI path (`node systems/workflow/workflow_executor.js ...`)
...
const legacy = require('./workflow_executor_legacy.js');
function runRustCli() {
