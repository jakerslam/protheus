...
/**
 * Runtime lane for SYSTEMS-WORKFLOW-ACCOUNT-CREATION-PROFILE-EXTENSION.
...
const lane = createLaneModule('SYSTEMS-WORKFLOW-ACCOUNT-CREATION-PROFILE-EXTENSION', ROOT);
