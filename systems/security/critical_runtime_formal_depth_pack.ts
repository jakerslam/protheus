...
/**
 * Runtime lane for SYSTEMS-SECURITY-CRITICAL-RUNTIME-FORMAL-DEPTH-PACK.
...
const lane = createLaneModule('SYSTEMS-SECURITY-CRITICAL-RUNTIME-FORMAL-DEPTH-PACK', ROOT);
