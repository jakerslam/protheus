...
/**
 * Runtime lane for SYSTEMS-SECURITY-EXECUTION-SANDBOX-RUST-WASM-COPROCESSOR-LANE.
...
const lane = createLaneModule('SYSTEMS-SECURITY-EXECUTION-SANDBOX-RUST-WASM-COPROCESSOR-LANE', ROOT);
