...
| BL-027 | doing | Execution-worthiness scoring at queue admission | Prioritize proposals that are concrete and executable, not meta-coordination noise | Queue admission computes deterministic execution-worthiness score (objective clarity, command concreteness, verification strength, rollback quality) and blocks low-scoring proposals with explicit reasons |
