...
|---|---:|---:|---:|---:|
| Cold start | 4.8 ms | 4.0 ms | 2.1 ms | 74.5 ms |
| Idle memory | 9.7 MB | 1.4 MB | 1.4 MB | 22.1 MB |
| Install size (full) | 11.5 MB | 0.7 MB | 0.5 MB | 126.4 MB |
| Throughput | 12,763.5 ops/sec | 12,168.2 ops/sec | 12,540.3 ops/sec | 7,420.0 ops/sec |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| **InfRing (rich)** | **11.5** | **4.8 ms** | **9.7** | **12,763.5** | **0.4** | **83** | 6 | 3 |
| **InfRing (pure)** | **0.7** | **4.0 ms** | **1.4** | **12,168.2** | **0.4** | **83** | 0 | 0 |
| **InfRing (tiny-max)** | **0.5** | **2.1 ms** | **1.4** | **12,540.3** | **0.3** | **83** | 0 | 0 |
