...
| Metric | Protheus (OpenClaw Runtime) |
|---|---|
| Cold start | 200.4 ms |
| Idle memory | 33.6 MB |
| Install size (full) | 82.5 MB |
| Throughput | 12,894 ops/sec |
| Static daemon size (musl + UPX) | 0.557 MB |
| Security systems | 83 |
| Channel adapters | 6 |
| LLM providers | 3 |
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| **Protheus (OpenClaw Runtime)** | **82.5** | **200 ms** | **33.6** | **12,894** | **0.557** | **83** | 6 | 3 |
