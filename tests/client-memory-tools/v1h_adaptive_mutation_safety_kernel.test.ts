...
function main() {
  ...
  console.log('v1h_adaptive_mutation_safety_kernel.test.ts: OK');
}
try { main(); } catch (err) { console.error(`v1h_adaptive_mutation_safety_kernel.test.ts: FAIL: ${err.message}`); process.exit(1); }
