...
function main() {
  ...
  console.log('release_gate_canary_rollback_enforcer.test.ts: OK');
}
try { main(); } catch (err) { console.error(`release_gate_canary_rollback_enforcer.test.ts: FAIL: ${err.message}`); process.exit(1); }
