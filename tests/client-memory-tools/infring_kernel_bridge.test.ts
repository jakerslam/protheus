...
const { invokeKernel, invokeKernelPayload } = require('../../client/runtime/lib/infring_kernel_bridge.ts');
...
function main() {
  ...
  console.log(JSON.stringify({ ok: true, type: 'infring_kernel_bridge_test' }));
}
