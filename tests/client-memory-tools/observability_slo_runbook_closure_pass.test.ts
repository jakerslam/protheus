...
function main() {
  ...
  console.log('observability_slo_runbook_closure_pass.test.ts: OK');
}
try { main(); } catch (err) { console.error(`observability_slo_runbook_closure_pass.test.ts: FAIL: ${err.message}`); process.exit(1); }
