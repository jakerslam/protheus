...
function main() {
  ...
  console.log('full_pipeline_e2e_hardening_pack.test.ts: OK');
}
try { main(); } catch (err) { console.error(`full_pipeline_e2e_hardening_pack.test.ts: FAIL: ${err.message}`); process.exit(1); }
