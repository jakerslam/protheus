...
function main() {
  ...
  console.log('operator_runbook_bl034_contract.test.ts: OK');
}

try { main(); } catch (err) { console.error(`operator_runbook_bl034_contract.test.ts: FAIL: ${err.message}`); process.exit(1); }
