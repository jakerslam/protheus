...
function main() {
  ...
  console.log('recursive_introspection_baseline_readonly.test.ts: OK');
}
try { main(); } catch (err) { console.error(`recursive_introspection_baseline_readonly.test.ts: FAIL: ${err.message}`); process.exit(1); }
