...
function main() {
  ...
  console.log('low_urgency_batch_execution_lane.test.ts: OK');
}
try { main(); } catch (err) { console.error(`low_urgency_batch_execution_lane.test.ts: FAIL: ${err.message}`); process.exit(1); }
