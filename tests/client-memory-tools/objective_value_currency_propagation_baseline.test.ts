...
function main() {
  ...
  console.log('objective_value_currency_propagation_baseline.test.ts: OK');
}
try { main(); } catch (err) { console.error(`objective_value_currency_propagation_baseline.test.ts: FAIL: ${err.message}`); process.exit(1); }
