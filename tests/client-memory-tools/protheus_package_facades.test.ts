...
const core = require('../../packages/protheus-core/index.ts');
const edge = require('../../packages/protheus-edge/index.ts');
...
function main() {
  ...
  console.log(JSON.stringify({ ok: true, type: 'protheus_package_facades_test' }));
}
