/**
 * sensory_queue.test.ts - Sensory Layer v1.2.3 Proposal Queue Tests
 * 
  ...
  const proposals = [
    {
      ...
      action_spec: {
        ...
        next_command: 'node client/runtime/systems/routing/route_execute.ts --task="Optimize routing spend with measurable verification" --dry-run',
    ...
    },
    {
      ...
      action_spec: {
        ...
        next_command: 'node client/runtime/systems/routing/route_execute.ts --task="Run low quality test" --dry-run',
  ...
  const proposals = [
    {
      ...
      action_spec: {
        ...
        next_command: 'node client/runtime/systems/routing/route_execute.ts --task=\"Diagnose collector failure and apply deterministic fallback\" --dry-run',
        verify: [
