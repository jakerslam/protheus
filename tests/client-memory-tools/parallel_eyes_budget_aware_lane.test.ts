...
function main() {
  ...
  console.log('parallel_eyes_budget_aware_lane.test.ts: OK');
}
try { main(); } catch (err) { console.error(`parallel_eyes_budget_aware_lane.test.ts: FAIL: ${err.message}`); process.exit(1); }
