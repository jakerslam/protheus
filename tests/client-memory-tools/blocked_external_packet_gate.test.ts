...
function main() {
  run('node client/runtime/lib/ts_entrypoint.ts tests/tooling/scripts/ci/srs_actionable_map.ts');
  run('node client/runtime/lib/ts_entrypoint.ts tests/tooling/scripts/ci/blocked_external_unblock_plan.ts');
  run('node client/runtime/lib/ts_entrypoint.ts tests/tooling/scripts/ci/blocked_external_evidence_status.ts');
  run('node client/runtime/lib/ts_entrypoint.ts tests/tooling/scripts/ci/blocked_external_packet_gate.ts');
