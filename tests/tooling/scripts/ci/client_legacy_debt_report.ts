...
function classify(file) {
  ...
  if (file.startsWith('client/install.') || file.startsWith('client/runtime/deploy/') || file.startsWith('client/cli/bin/') || file.startsWith('packages/infring-npm/') || file.startsWith('client/cli/tools/')) return 'installer_or_dev_shell';
  ...
  if (file.startsWith('client/cognition/habits/routines/') || file.startsWith('client/cognition/habits/scripts/') || file.startsWith('client/cognition/personas/')) return 'cognition_runtime_surface';
  ...
  if (file.startsWith('tests/tooling/scripts/memory/')) return 'tooling_or_test_debt';
