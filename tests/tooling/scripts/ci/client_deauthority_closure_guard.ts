...
const POLICY = 'validation/conformance/contracts/shell_truth_leak_policy.json';
const FIXTURE = 'validation/regression/fixtures/workflow_failure_recovery_matrix.json';
