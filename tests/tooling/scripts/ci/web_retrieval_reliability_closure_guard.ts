...
function main(): void {
  ...
  const checks: Check[] = [
    ...
    check('batch_query_quality_diagnostics_present', includesAll(batchQuery, ['tool_result_quality', 'source_trust_adjustment', 'ranked_payload_links_for_fallback', 'candidate_quality', 'synthesis_contract', 'input_contract', 'agent_submitted', 'potential_source_conflict']), missingTokens(batchQuery, ['tool_result_quality', 'source_trust_adjustment', 'ranked_payload_links_for_fallback', 'candidate_quality', 'synthesis_contract', 'input_contract', 'agent_submitted', 'potential_source_conflict']).join(', ')),
    check('batch_query_web_quality_action_list_covered', includesAll(batchQuery, ['contains_web_junk_marker', 'recency_adjustment', 'select_diverse_ranked_candidates', 'snippet_preview', 'comparative_synthesis_required', 'hidden_query_expansion', 'current_year']), missingTokens(batchQuery, ['contains_web_junk_marker', 'recency_adjustment', 'select_diverse_ranked_candidates', 'snippet_preview', 'comparative_synthesis_required', 'hidden_query_expansion', 'current_year']).join(', ')),
