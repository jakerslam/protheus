 ...
 * 
 * Usage: node tests/tooling/scripts/memory/normalize_nodes.ts [--dry-run]
 */
...
console.log('Next step: Run node tests/tooling/scripts/memory/lint_memory.ts to verify');
